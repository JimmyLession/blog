...
var _upgrade = __webpack_require__(2);
...
_upgrade2.default.el = '#root';
new Vue(_upgrade2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\myGrade\\upgrade.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-52ccbd7e"
...
var bottom = 0;
exports.default = {
    components: { line: _line2.default, titleBar: _titleBar2.default },
    data: function data() {
        return {
            title: '经销等级',
            height: height,
            ...
            level_name: '', //等级名称
            upgrade_day: '', //天数
            total_achievement: '', //已订货钱
            reduce: '', //再订货多少钱可升级
            upgrade_level_name: '', //升级后的等级
            high_price: '',
            activity_achievement: '', //活动期间已订货钱
            activity_level_name: '', //活动升级后的等级
            activity_reduce: '', //活动再订货多少钱可升级
            level_width: '', //等级进度条
            active_width: '' //活动等级进度条
        };
    },
    ...
    methods: {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().achievement, {}, function (res) {
                if (res.data.code == '0') {
                    //    promptModule.showPrompt({msg:'123',type:'err'});
                    _this.level = res.data.data.level;
                    _this.level_name = res.data.data.level_name;
                    _this.upgrade_day = res.data.data.upgrade_day;
                    _this.total_achievement = res.data.data.total_achievement;
                    _this.reduce = res.data.data.reduce;
                    _this.upgrade_level_name = res.data.data.upgrade_level_name;
                    _this.high_price = parseFloat(res.data.data.high_price);
                    _this.activity_achievement = res.data.data.activity_achievement;
                    _this.activity_level_name = res.data.data.activity_level_name;
                    _this.activity_reduce = res.data.data.activity_reduce;
                    _this.level_width = parseInt(res.data.data.total_achievement) / (parseInt(res.data.data.total_achievement) + parseInt(res.data.data.reduce)) * 600;
                    _this.active_width = parseInt(res.data.data.activity_achievement) / (parseInt(res.data.data.activity_achievement) + parseInt(res.data.data.activity_reduce)) * 600;
                } else {
                    promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                }
            });
        },
        seeDeatil: function seeDeatil() {
            this.jumpTo2('myGrade/performance', '', {});
        },
        clickRecharge: function clickRecharge() {
            var self = this;
            self.jumpTo2('personal/recharge/rechargeUpgradeLevel', '', {});
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.level == 2 || _vm.level == 3) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "https://static.abmau.com/assets/img/h5/data/Primary_icon.png"
    }
  }) : _vm._e(), (_vm.level == 4) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "https://static.abmau.com/assets/img/h5/data/Medium_icon.png"
    }
  }) : _vm._e(), (_vm.level == 5) ? _c('image', {
    staticClass: ["icon"],
    attrs: {
      "src": "https://static.abmau.com/assets/img/h5/data/Advanced_icon.png"
    }
  }) : _vm._e()]), _c('div', {
    staticClass: ["head-right"]
  }, [_c('text', {
    class: ['cn', 'level-color' + _vm.level]
  }, [_vm._v(_vm._s(_vm.level_name))]), (_vm.level == 2 || _vm.level == 3) ? _c('text', {
    class: ['en', 'level-color' + _vm.level]
  }, [_vm._v("Primary Distributor")]) : _vm._e(), (_vm.level == 4) ? _c('text', {
    class: ['en', 'level-color' + _vm.level]
  }, [_vm._v("Medium Distributor")]) : _vm._e(), (_vm.level == 5) ? _c('text', {
    class: ['en', 'level-color' + _vm.level]
  }, [_vm._v("Advanced Distributor")]) : _vm._e()])]) : _vm._e(), _c('cell', {
    staticClass: ["level"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    ...
    class: ['level-son', 'level-bg' + _vm.level],
    style: {
      width: _vm.level_width + 'px'
    }
  })]), _c('div', {
    class: ['end-bar', 'end-bar-color' + _vm.level],
    style: {
      left: _vm.level_width + 75 + 'px'
    }
  })]), _c('cell', {
    staticClass: ["upgrade"],
    appendAsTree: true,
  ...
  }, [_vm._v(_vm._s(_vm.upgrade_day) + "天内,已订货" + _vm._s(_vm.total_achievement) + "元,再订货" + _vm._s(_vm.reduce) + "元,即可升为" + _vm._s(_vm.upgrade_level_name))]), _c('text', {
  ...
  }, [_vm._v("查看详情")])]), (_vm.level != 5) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["recharge-money"]
  }, [_vm._v("充值" + _vm._s(_vm.high_price) + "可立即升为高级VIP")]), _c('text', {
