...
var _performance = __webpack_require__(2);
...
_performance2.default.el = '#root';
new Vue(_performance2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\myGrade\\performance.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1174d6dc"
...
var bottom = 0;
exports.default = {
    components: { line: _line2.default, titleBar: _titleBar2.default, empty: _empty2.default, refresher: _refresh2.default },
    data: function data() {
        return {
            title: '近90天业绩',
            limit: 10,
    ...
    methods: {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().achievement, {
                offset: _this.offset,
                limit: _this.limit
            }, function (res) {
                if (res.data.code == '0') {
                    if (res.data.data.order_list_count == 0) _this.empty = true;else _this.empty = false;
                    if (res.data.data.order_list_count > _this.offset) {
                        _this.offset += 10;
                    ...
                    for (var i = 0; i < res.data.data.order_list.length; i++) {
                        _this.items.push(res.data.data.order_list[i]);
                    }
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("再订货" + _vm._s(_vm.reduce) + "元,即可升为" + _vm._s(_vm.upgrade_level_name))])]), _vm._l((_vm.items), function(item, index) {
    return _c('cell', {
      key: index,
      ref: "index",
      refInFor: true,
    ...
    }, [_vm._v(_vm._s(item.content.substring(0, 7)))]), _c('text', {
      staticClass: ["list-item-font-size"]
    }, [_vm._v(_vm._s(item.content.substring(7)))]), _c('text', {
      staticClass: ["list-item-font-size"]
    }, [_vm._v(_vm._s(item.created_at))])]), _c('div', {
      staticClass: ["list-item-font-size"]
    }, [_c('text', {
      staticClass: ["list-item-money"]
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.loading && _vm.items.length > 8) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
