...
var _releaseAgreement = __webpack_require__(2);

var _releaseAgreement2 = _interopRequireDefault(_releaseAgreement);
...
_releaseAgreement2.default.el = '#root';
new Vue(_releaseAgreement2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\material\\releaseAgreement.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-acd9576a"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("      基于您已经注册成为由寰唐国际贸易（上海）有限公司注册的移动端“单创”APP商城（该商城及相应注册人、经营人以下合称单创平台）的用户，根据您与单创平台间有效的《用户服务协议》及您个人拟在单创平台特定模块发布产品使用体验等内容的意愿，您与单创平台达成如下如下协议：")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第一条 单创平台鼓励用户充分利用平台发布产品使用体验及其他用户所有的合法信息，用户对于其创作并在单创平台上发布的合法内容依法享有著作权；任何经由单创平台发布的信息（包括但不限于文字、图片、语音、视频等）应符合本协议及相关法律规定，相应法律责任均由发布用户承担。单创平台无法控制经由本平台传送之信息，在任何情况下，单创平台均不为任何内容负责。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第二条 单创平台作为网络服务提供者，对非法转载，虚假发布、盗版或其他侵权行为的发生不具备充分的审查与监控能力。单创平台对用户在网站上实施的此类侵权行为不承担法律责任，侵权的法律责任概由用户本人承担。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第三条 用户所发布信息不得违反《计算机信息网络国际联网安全保护管理办法》、《互联网信息服务管理办法》、《互联网新闻信息服务管理规定》等相关法律规定，不得在单创平台发布、传播或以其它方式传送含有下列内容之一的信息：")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        1.反对宪法所确定的基本原则的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        2.危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        3.损害国家荣誉和利益的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        4.煽动民族仇恨、民族歧视、破坏民族团结的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        5.破坏国家宗教政策，宣扬邪教和封建迷信的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        6.散布谣言，扰乱社会秩序，破坏社会稳定的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        7.散布淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        8.侮辱或者诽谤他人，侵害他人合法权利的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        9.煽动非法集会、结社、游行、示威、聚众扰乱社会秩序的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        10.以非法民间组织名义活动的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        11.含有虚假、有害、胁迫、侵害他人隐私、骚扰、侵害、中伤、粗俗、猥亵、或其它道德上令人反感的内容；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        12.侵犯他人知识产权或其他合法权益的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        13.含有中国法律、法规、规章、条例以及任何具有法律效力之规范所限制或禁止的其它内容的。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第四条 用户不得违规在单创平台内发布非平台展示产品的广告。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第五条 用户应承担一切因其个人的行为而直接或间接导致的民事或行政或刑事法律责任，因用户行为给单创平台及相关经营人造成损失的，用户应负责赔偿。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第六条 单创平台拥有对违反本协议及其他平台规则的用户进行处理的权力。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第七条 禁止任何使用非法软件进行内容发布的行为。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第八条 任何用户发现其他用户所发布信息涉嫌侮辱或者诽谤他人、侵害他人合法权益等的，有权按平台投诉规则进行投诉。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第九条 出现下列情况任意一种或几种，将承担包括被关闭全部或者部分权限、被暂停或被删除其帐号的后果，情节严重的，还将承担相应的法律责任。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        1.使用不雅或不恰当ID和昵称；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        2.发表含有猥亵、色情、人身攻击和反政府言论等非法或侵权言论的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        3.从事非法商业活动；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        4.模仿平台管理人员ID或者他人ID，用以假冒管理人员或破坏管理人员形象；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        5.使用非法软件进行信息发布的行为；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        6.侵犯他人知识产权或其他合法权益的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        7.其他单创平台认为不恰当的情况。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第十条 凡用户所发布信息出现以下情况之一，单创平台有权不提前通知发布者直接删除，并依照有关规定作相应处罚。情节严重者，有权对其做出关闭部分权限、暂停直至删除其帐号。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        1.发表含有本协议禁止发布、传播内容的信息；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        2.同一内容信息多次出现的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        3.内容信息包含有严重影响用户浏览的内容或格式的；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      第十一条 本协议未约定事项以《用户服务协议》规定为准。")]), _c('text', {
    staticClass: ["content-title"]
  }, [_vm._v("法律声明与侵权投诉须知")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      1. 鉴于单创平台本模块“ 用户口碑 ”提供的信息发布服务属于电子公告牌（BBS）性质，模块中信息由用户自行提供并上传，由用户对其提供并上传的信息承担相应法律责任。单创平台服务提供者对此另有约定的，将在相关的协议或其他法律文本中与您进行明确。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      单创平台转载的作品（包括论坛内容）出于传递更多信息之目的，并不意味我们赞同其观点或已经证实其内容的真实性")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      2. 根据《中华人民共和国侵权责任法》第三十六条之规定，任何第三方认为用户利用单创平台侵害其民事权益或实施侵权行为的，包括但不限于侮辱、诽谤等，被侵权人有权书面通知单创平台采取删除、屏蔽、断开链接等必要措施。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      根据《信息网络传播权保护条例》之规定，任何第三方认为单创平台所涉及的作品、表演、录音录像制品，侵犯自己的信息网络传播权或者被删除、改变了自己的权利管理电子信息的，可以向单创平台提交书面通知，要求单创平台删除该侵权作品，或者断开链接。通知书应当包含下列内容：")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （一）权利人的姓名（名称）、联系方式和地址；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （二）要求删除或者断开链接的信息的名称和网络地址；")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （三）构成侵权的初步证明材料。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      权利人应当对通知书的真实性负责。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      3. 您同时应该了解，根据《信息网络传播权保护条例》之规定，单创平台有权将您的投诉通知书转送至相关信息发布者。该信息发布者接到转送的通知书后，认为其提供的信息未侵犯他人权利的，可以向单创平台提交书面说明，要求恢复被删除相应信息，或者恢复相应链接。单创平台接到信息发布者的书面说明后，有权立即恢复被删除的作品、表演、录音录像制品，或者恢复相应链接，同时将该信息发布者的书面说明转送投诉人。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      4. 任何第三方（包括但不限于企业、公司、单位或个人等）认为单创平台用户发布的任何信息侵犯其合法权益的，包括但不限于以上两点，在有充分法律法规及证据足以证明的情况下，可以按照本指引文件提供的联系方式进行投诉。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      5. 为了明确法律责任，方便单创平台依法依约及时作出处理，除前述指引已提及之投诉内容外，侵权投诉还应包含下述信息：")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （1）被侵权人的证明材料，或被侵权作品的原始链接及其它证明材料。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （2）侵权信息或作品在单创平台上的具体链接。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （3）侵权投诉人的联络方式，以便单创平台相关部门能及时回复您的投诉，最好包括电子邮件地址、电话号码或手机等。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （4）投诉内容须包括以下声明：“本人本着诚信原则，有证据认为该对象侵害本人或他人的合法权益。本人承诺投诉全部信息真实、准确，否则自愿承担一切后果。”")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      （5）本人亲笔签字并注明日期，如代理他人投诉的，必须出具授权人签字、盖章的授权书。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      6. 投诉人可以通过下列方式通知单创平台，将投诉资料邮寄至下述地址：")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        邮寄地址：  浙江省杭州市江干区九堡镇东方电子商务园11幢6楼")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        邮政编码：310019")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        收件人： 圆圆")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("        电子邮箱：abmts@idanchuang.com")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      7. 单创平台建议您在提起投诉之前咨询法律顾问或律师。我们提请您注意：投诉人应当对其投诉内容的准确性、客观性、合法性、完整性承担责任。如果侵权投诉不实，则用户可能承担法律责任；如果投诉通知内容不准确、不完整，则投诉人应承担因此造成的后果。")]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v("      8. 投诉人须了解，单创平台仅有权利和义务在法律法规规定及平台规则约定的范围内，在网站工作人员的认知水平和能力、资格范围内对投诉作出判断和处理或答复。这一处理机制不同于也无意替代司法机关的裁断。单创平台亦无意介入投诉人与被投诉人之间的纠纷。单创平台不对您的投诉是否能够得到某种结果作出任何承诺或者保证，亦不因对您的投诉处理行为而承担任何义务或者责任。")])])
}]}
module.exports.render._withStripped = true
