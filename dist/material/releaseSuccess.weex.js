...
var _releaseSuccess = __webpack_require__(2);

var _releaseSuccess2 = _interopRequireDefault(_releaseSuccess);
...
_releaseSuccess2.default.el = '#root';
new Vue(_releaseSuccess2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\material\\releaseSuccess.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a26e97f8"
...
exports.default = {
    ...
    methods: {
        ...
        submit: function submit() {
            if (weex.config.env.platform.toLowerCase() === 'ios') {
                this.jumpTo2("material/myPublish", "", { release_type: this.type });
            } else if (weex.config.env.platform.toLowerCase() === 'android') {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("恭喜您 发布成功 请等待审核通过")]), _c('div', {
  ...
  return _c('div', {
    ...
    attrs: {
      "src": "assets://icon_refresh_success"
    }
  })])
}]}
module.exports.render._withStripped = true
