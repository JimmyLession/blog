...
var _collectIndex = __webpack_require__(5);

var _collectIndex2 = _interopRequireDefault(_collectIndex);
...
_collectIndex2.default.el = '#root';
new Vue(_collectIndex2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\material\\collectIndex.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7eb0bc60"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _titleBar = __webpack_require__(0);
...
var _myFavorites = __webpack_require__(17);
...
var bottom = 0;
exports.default = {
    components: { titleBar: _titleBar2.default, line: _line2.default, empty: _empty2.default, myFavorites: _myFavorites2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom
