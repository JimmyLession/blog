...
var _materialSearch = __webpack_require__(2);
...
_materialSearch2.default.el = '#root';
new Vue(_materialSearch2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\material\\materialSearch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-36cfb637"
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            data_key: "abm_user_lately_data",
            lately_data: [],
            guessseek_data: ["测试", "测试11111"]
        };
    },
    ...
    methods: {
        selectTitleJump: function selectTitleJump(ret) {
            ...
            storage.setItem(_this.data_key, JSON.stringify(_this.lately_data), function (event) {
        ...
        closeKeyboard: function closeKeyboard(e) {
            this.selectTitleJump(e.value);
        },
        cleanLocalCacheData: function cleanLocalCacheData() {
            var _this = this;
            storage.setItem(_this.data_key, "", function (event) {
                if (event.result == "success") {
                    _this.lately_data = [];
                }
            });
    ...
    created: function created() {
        ...
        storage.getItem(_this.data_key, function (event) {
            if (event.result == "success") {
                _this.lately_data = JSON.parse(event);
            }
        });
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("关闭")])]), _c('line')], 1), _c('div', {
    staticClass: ["header"]
  }, [_c('div', {
    staticClass: ["item"]
  }, [(_vm.lately_data.length != 0) ? _c('div', {
  ...
  }, [_vm._v("清除")])]) : _vm._e(), (_vm.lately_data.length != 0) ? _c('div', {
    ...
    staticClass: ["item"]
  }, [(_vm.guessseek_data.length != 0) ? _c('div', {
    staticClass: ["row", "between"]
  }, [_c('text', {
    staticClass: ["item_title"]
  }, [_vm._v("猜你想找")])]) : _vm._e(), (_vm.guessseek_data.length != 0) ? _c('div', {
    staticClass: ["row", "wrap"]
