...
var _favoriteDetail = __webpack_require__(2);

var _favoriteDetail2 = _interopRequireDefault(_favoriteDetail);
...
_favoriteDetail2.default.el = '#root';
new Vue(_favoriteDetail2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\material\\favoriteDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ede9fad6"
...
var _releaseList = __webpack_require__(13);
...
var bottom = 0;
exports.default = {
    components: { titleBar: _titleBar2.default, line: _line2.default, material: _releaseList2.default, empty: _empty2.default, dialog: _dialog2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
    ...
    methods: {
        resetData: function resetData(data) {
            ...
            data.map(function (item, i) {
                ...
                } else if (item.video_album && item.video_album.length > 0) {
        ...
        resetVideo: function resetVideo(data) {
            ...
            data.video_album.map(function (item, i) {
                item.url = item.img_url;
                if (data.video_album.length == 1) {
                    if (item.width == item.height) {
                        item.width = 400;
                        item.height = 400;
                    } else if (item.width > item.height) {
        ...
        wxcMinibarRightButtonClicked: function wxcMinibarRightButtonClicked() {
            this.jumpTo2('material/createFavorite', '', { title: this.title, id: this.id });
        },
        getFavoriteDetailList: function getFavoriteDetailList() {
            var self = this;
            self.data = [];
            self.Get(self.api().material_list, {
                id: self.id
            }, function (res) {
                if (res.data.code != '0') {
                    //请求数据失败
                    ...
                    //请求数据成功
                    res.data.data = self.resetData(res.data.data);
        ...
        jumpToCollection: function jumpToCollection() {
            //跳转到收藏夹
            this.jumpTo2('material/collection', '', {});
        },
    ...
    created: function created() {
        ...
        self.getFavoriteDetailList();
        collectNum.onmessage = function (event) {
            if (!event.data) {
                return;
            }
            if (self.collectionData && self.collectionIndex != -1) {
                var num = !self.collectionData.collect_times || self.collectionData.collect_times == '' ? 0 : self.collectionData.collect_times;
                var scale = 1;
                switch (event.data.type) {
                    case self.eventBusTag().COLLECTION_CANCEL:
                        self.getFavoriteDetailList();
                        break;
                    case self.eventBusTag().COLLECTION_MATERIAL:
                        self.getFavoriteDetailList();
                        break;
                }
            }
...
var _pictureGrid = __webpack_require__(16);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return (_vm.data.length != 0) ? _c('cell', {
      ...
      on: {
        "collection": function($event) {
          _vm.jumpCollection($event, _vm.index)
        },
      ...
      attrs: {
        "src": "http://pic35.photophoto.cn/20150516/0005018639255973_b.jpg"
      }
    }), _c('text', {
      staticClass: ["handle-edit-reason"]
    }, [_vm._v("您的素材产图片拍摄去过于模糊,请及时修改重新提交审核您的素材")]), _c('image', {
      staticClass: ["handle-common-img"],
      attrs: {
        "src": "http://pic35.photophoto.cn/20150516/0005018639255973_b.jpg"
      }
    ...
    }, [_vm._v("修改")])]) : _vm._e()], 1) : _vm._e()
  }), (_vm.data.length == 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  }, [_c('empty')], 1) : _vm._e()], 2), _c('dialog', {
    attrs: {
