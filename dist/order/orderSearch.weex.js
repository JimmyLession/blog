...
var _orderSearch = __webpack_require__(2);
...
_orderSearch2.default.el = '#root';
new Vue(_orderSearch2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\order\\orderSearch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2c48f30a"
...
var _orderManager = __webpack_require__(9);
...
var bottom = 0;
exports.default = {
    components: { orderManager: _orderManager2.default, title: _titleBar2.default },
    data: function data() {
        return {
            bottom: bottom,
            height: height,
    ...
    methods: {
        ...
        cancelOrder: function cancelOrder() {
            orderEvent.postMessage(this.eventBusTag().ORDER_CANCEL);
        },
        finishOrder: function finishOrder() {
            orderEvent.postMessage(this.eventBusTag().ORDER_FINISH);
        }
    },

    created: function created() {
        this.getTopHeight(this, false);
        this.isIpx(this);
        var keyword = this.GetUrlPara(weex.config.bundleUrl, 'keyword');
...
var _refresh = __webpack_require__(12);
