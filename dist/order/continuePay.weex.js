...
var _continuePay = __webpack_require__(2);
...
_continuePay2.default.el = '#root';
new Vue(_continuePay2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\order\\continuePay.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-34f268e6"
...
var _orderGoods = __webpack_require__(13);
...
exports.default = {
    components: { title: _titleBar2.default, line: _line2.default, orderGoods: _orderGoods2.default },
    data: function data() {
        return {
            sn_id: 0,
            trial_activity_id: 0,
    ...
    methods: {
        ...
        clickAgreement: function clickAgreement() {
            this.jumpTo2('web/webView', '用户购买须知', { title: "用户购买须知", url: encodeURIComponent("https://wap.abmau.com/user_buy.html") });
        },
        ...
        showConfirmDialog: function showConfirmDialog() {
            ...
            promptModule.show({ title: '温馨提示',
                ...
                if (result == 'success') {
                    var jumpType = "";
                    if (_this.trial_activity_id > 0) jumpType = "tryout_continue";else jumpType = "continue";
                    _this.jumpTo2('order/payOrder', '', { b_order_ids: _this.b_order_ids, type: jumpType });
                }
            });
        },
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().shopping_waiting_pay, {
                order_id: _this.sn_id,
                trial_activity_id: _this.trial_activity_id
            }, function (res) {
                if (res.data.code == 0) {
                    _this.item = res.data.data.item;
                    _this.coupon_info = res.data.data.coupon_info;
                    _this.depot_name = res.data.data.data.name;
                    _this.tariff_fee = res.data.data.data.tariff_fee;
                    _this.shipping_fee = res.data.data.data.shipping_fee;
                    _this.total_price = res.data.data.data.amount;
                    _this.address_name = res.data.data.data.shipping_name;
                    _this.address_mobile = res.data.data.data.shipping_mobile;
                    _this.shipping_address = res.data.data.data.shipping_address;
                    _this.shipping_idcard_no = res.data.data.data.shipping_idcard_no;
                    _this.sn = res.data.data.data.sn;
                    _this.depot_id = res.data.data.data.depot_id;
                    if (_this.depot_id == 20) _this.shipping_title = "进口综合费";else _this.shipping_title = "税费";
                    _this.b_order_ids = res.data.data.data.b_order_ids;
                    _this.coupon_provider_level = _this.coupon_info.coupon_provider_level;
                    if (_this.coupon_info.title != '') _this.coupon_des = _this.coupon_info.title;else _this.coupon_des = "未使用特权劵";
    ...
    created: function created() {
        ...
        this.isIpx(this);
        this.sn_id = this.GetUrlPara(weex.config.bundleUrl, 'sn_id');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.address_name))]), _c('text', {
    staticClass: ["address_mobile"]
  }, [_vm._v(_vm._s(_vm.address_mobile))]), (_vm.shipping_idcard_no == 0) ? _c('div', {
    staticClass: ["tag_gray"]
  }, [_c('text', {
    staticClass: ["address_isHas_idCard"]
  }, [_vm._v("无身份证")])]) : _vm._e(), (_vm.shipping_idcard_no == 1) ? _c('div', {
    staticClass: ["tag_back"]
  }, [_c('text', {
    staticClass: ["address_isHas_idCard"]
  }, [_vm._v("有身份证")])]) : _vm._e()]), _c('text', {
    staticClass: ["address_des"]
  }, [_vm._v(_vm._s(_vm.shipping_address))])]), (false) ? _c('image', {
    staticClass: ["next"],
    attrs: {
  ...
  }, [_vm._v("订单编号：" + _vm._s(_vm.sn) + "  " + _vm._s(_vm.depot_name))]), _c('line'), _vm._l((_vm.item), function(content, position) {
    return _c('div', {
      key: position,
      staticClass: ["list"]
    }, [_c('div', {
    ...
    }, [_vm._v("¥ " + _vm._s(content.price))]), (!content.spec_name) ? _c('text', {
      staticClass: ["goods_num_tax"]
    }, [_vm._v("x " + _vm._s(content.count))]) : _vm._e()]), (content.spec_name) ? _c('div', {
      staticClass: ["goods_price_info"]
    }, [_c('text', {
      staticClass: ["goods_retail_price"]
    }, [_vm._v(_vm._s(content.spec_name))]), _c('text', {
      staticClass: ["goods_num"]
    }, [_vm._v("x " + _vm._s(content.count))])]) : _vm._e()])])]), _c('line')], 1)])
  }), (false) ? _c('div', {
  ...
  }, [_vm._v("含税商品价 ¥" + _vm._s(_vm.v.order_price))]), _c('text', {
    staticClass: ["total_price"]
  }, [_vm._v("合计 ¥" + _vm._s(_vm.v.total_price))])]), _c('div', [_c('text', {
    staticClass: ["item_price"]
  }, [_vm._v("含税运费 ¥" + _vm._s(_vm.v.shipping_fee))])])]) : _vm._e()], 2), _c('div', {
    staticClass: ["line"]
  }), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.coupon_des))]), (false) ? _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
    ...
    staticClass: ["price_title"]
  }, [_vm._v("¥" + _vm._s(_vm.shipping_fee))])])]), _c('line'), _c('div', {
    staticClass: ["order_price_content"]
  }, [_c('text', {
    staticClass: ["price_title"]
  }, [_vm._v(_vm._s(_vm.shipping_title))]), _c('text', {
    staticClass: ["price_title"]
  }, [_vm._v("¥" + _vm._s(_vm.tariff_fee))])]), _c('line'), _c('div', {
  ...
  }, [_vm._v("同意并接受《跨境商品用户购买须知》")])])], 1), _c('div', {
