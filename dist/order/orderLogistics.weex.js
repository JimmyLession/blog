...
var _orderLogistics = __webpack_require__(4);

var _orderLogistics2 = _interopRequireDefault(_orderLogistics);
...
_orderLogistics2.default.el = '#root';
new Vue(_orderLogistics2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\order\\orderLogistics.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-22ce5b10"
...
module.exports = {
  ...
  "list-item-left-top-verticle-line": {
    "position": "absolute",
    "top": "80",
    "bottom": 0,
    "left": "60",
  ...
  "list-item-left-top-verticle-line1": {
    "position": "absolute",
    "top": "0",
    "bottom": 0,
    "left": "60",
  ...
  "list-item-left-top-verticle-line2": {
    "position": "absolute",
    "top": "0",
    "height": "50",
    "left": "60",
  ...
  "list-item-left-circle-whrite": {
    "width": "15",
    "height": "15",
    "backgroundColor": "#ffffff",
    "borderRadius": 50
  },
  "list-item-left-circle-gray": {
    "position": "absolute",
    "top": "50",
    "bottom": 0,
    "left": "45",
...
var _refresh = __webpack_require__(24);
...
exports.default = {
    components: { WxcTabPage: _wxcTabPage2.default, empty: _empty2.default, title: _titleBar2.default, refresher: _refresh2.default },
    data: function data() {
        return {
            supportSlide: false,
            isTabView: true,
            ...
            type: 'all',
            data: null, //单个包裹的物流信息
            tabList: [], //将所有包裹的物流信息放入一个二维数组
            orderId: '', //订单id,
            transportNo: [] //包裹订单号，数组形式
        };
    },
    ...
    methods: {
        ...
        loadingDown: function loadingDown() {
            var self = this;
            self.data = null;
            self.getOrderTransport(self.transportNo[self.index]);
        },
        ...
        wxcTabPageCurrentTabSelected: function wxcTabPageCurrentTabSelected(e) {
            ...
            self.index = e.page;
            self.data = null;
            self.getOrderTransport(self.transportNo[self.index], self.index);
        },

        //获取tab的标题
        getTabTitle: function getTabTitle() {
            var self = this;
            self.Get(self.api().get_order_transport_name, {
                orderId: self.orderId
            }, function (res) {
                if (res.data.code == '0') {
                    for (var i = 0; i < res.data.data.length; i++) {
                        self.tabTitles.push({
                            title: res.data.data[i].transportName,
                            depot_id: res.data.data[i].depot_id
                        });
                        self.transportNo.push(res.data.data[i].transportNo);
                    }
                    // console.log(JSON.stringify(self.transportNo));
                    self.tabList = [].concat(_toConsumableArray(Array(self.tabTitles.length).keys())).map(function (i) {
                        return [];
                    });
                    self.getOrderTransport(self.transportNo[0], self.index);
                } else {
                    //请求失败
        ...
        //获取当前包裹的物流信息
        getOrderTransport: function getOrderTransport(transportNo, index) {
            var self = this;
            self.Get(self.api().get_order_transport, {
                orderId: self.orderId,
                transportNo: transportNo
            }, function (res) {
                if (res.data.code == '0') {
                    for (var i = 0; i < res.data.data.length; i++) {
                        self.data = res.data.data[i];
                    }
                    Vue.set(self.tabList, index, self.data);
                } else {
                    //请求失败
                    promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                }
        ...
        //复制订单号
        copyClick: function copyClick(sn) {
    ...
    created: function created() {
        ...
        self.orderId = self.GetUrlPara(weex.config.bundleUrl, 'sn_id');
        self.getTabTitle();
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.tabList), function(items, key) {
    return _c('list', {
      key: key,
      ...
      staticClass: ["head-express"]
    }, [_vm._v("物流公司：" + _vm._s(items.TransferName))]), _c('div', {
      staticClass: ["head-order"]
    }, [_c('text', {
      staticClass: ["head-tracking-number"]
    }, [_vm._v("物流单号：" + _vm._s(items.TransferNo))]), (items && items.TransferNo != '') ? _c('text', {
      staticClass: ["head-copy"],
      on: {
        "click": function($event) {
          _vm.copyClick(items.TransferNo)
        }
      }
    }, [_vm._v("复制")]) : _vm._e()])])]), _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
      ...
      return _c('div', {
        ...
        staticClass: ["list-item-left-top-verticle-line"]
      }) : _vm._e(), (index != 0 && index != items.List.length - 1) ? _c('text', {
        staticClass: ["list-item-left-top-verticle-line1"]
      }) : _vm._e(), (index == items.List.length - 1 && index !== 0) ? _c('text', {
        staticClass: ["list-item-left-top-verticle-line2"]
      }) : _vm._e(), (index == 0) ? _c('div', {
        staticClass: ["list-item-left-circle-red"]
      }, [_c('div', {
        staticClass: ["list-item-left-circle-whrite"]
      })]) : _vm._e(), (index != 0) ? _c('div', {
        staticClass: ["list-item-left-circle-gray"]
      }) : _vm._e(), _c('div', {
        staticClass: ["list-item-right"]
      }, [_c('div', {
        staticClass: ["list-item-right-top"]
      }), _c('div', {
        staticClass: ["list-item-right-content"]
      }, [_c('text', {
        staticClass: ["list-item-right-content-text"]
      }, [_vm._v(_vm._s(item.msg))])]), _c('div', {
        staticClass: ["list-item-right-bottom"]
      }, [_c('text', {
        staticClass: ["list-item-right-bottom-text"]
