...
var _forgetPasswordFirstStep = __webpack_require__(2);

var _forgetPasswordFirstStep2 = _interopRequireDefault(_forgetPasswordFirstStep);
...
_forgetPasswordFirstStep2.default.el = '#root';
new Vue(_forgetPasswordFirstStep2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\login\\forgetPasswordFirstStep.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-24c51458"
...
exports.default = {
    ...
    methods: (_methods = {
        onInputMobile: function onInputMobile(e) {
            ...
            this.isParam = this.isValueParam(this, [this.applyMobile, this.applyMobileCode, this.applyPsw]);
        },
        ...
        finish: function finish() {
            if (this.type == "add") this.popBar();else this.finishAnim();
        },
        alterCode: function alterCode() {
            this.jumpTo2('other/codeHelp', '帮助', { mobile: this.area_code + this.applyMobile, type: this.applyMobile });
        }
    }, _defineProperty(_methods, 'finish', function finish() {
        this.finishAnim();
    }), _defineProperty(_methods, 'clickArea', function clickArea() {
        this.jumpTo2('region/region', '选择所在国家及区号', {});
    }), _defineProperty(_methods, 'sendCode', function sendCode() {
        var _this = this;
    ...
    }), _defineProperty(_methods, 'clickNext', function clickNext() {
        var _this = this;
        if (_this.applyMobile == "") {
            promptModule.showPrompt({ msg: '请输入手机号码', type: 'prompt' });
            return;
        ...
        if (_this.applyPsw == "") {
            promptModule.showPrompt({ msg: '请输入新密码', type: 'prompt' });
            return;
        }

        _this.md5(_this.applyPsw, function (ret) {
            //_this.applyPsw = ret.md5;
            var md5Password = ret.md5;
            var areaCode = _this.area_code.replace('+', '%2B');
            loadingModule.show({ msg: '正在修改...' });
            _this.Post(_this.api().change_password, {
                mobile: areaCode + _this.applyMobile,
