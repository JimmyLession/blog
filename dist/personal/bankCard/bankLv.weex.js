...
var _bankLv = __webpack_require__(2);

var _bankLv2 = _interopRequireDefault(_bankLv);
...
_bankLv2.default.el = '#root';
new Vue(_bankLv2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\bankCard\\bankLv.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-348c43d2"
...
exports.default = {
    ...
    methods: {
        ...
        selectItem: function selectItem(item) {
            var _this = this;
            storage.setItem('choose_bank', JSON.stringify(item), function (event) {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().bank_code, {}, function (res) {
                if (res.data.code == '0') {
    ...
    created: function created() {
        ...
        this.isIpx(this);
        this.bank_name = this.GetUrlPara(weex.config.bundleUrl, 'bank_name');
        this.fetch();
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('scroller', _vm._l((_vm.data), function(item) {
    return (_vm.data.length != 0) ? _c('div', [_c('div', {
      staticClass: ["item"],
      on: {
      ...
      staticClass: ["content"]
    }, [_vm._v(_vm._s(item.name))]), (_vm.bank_name == item.name) ? _c('image', {
      staticClass: ["selected"],
      attrs: {
        "src": "assets://xuanzhong"
      }
    }) : _vm._e()]), _c('line')], 1) : _vm._e()
  }))])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
