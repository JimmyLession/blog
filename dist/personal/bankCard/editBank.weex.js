...
var _editBank = __webpack_require__(2);

var _editBank2 = _interopRequireDefault(_editBank);
...
_editBank2.default.el = '#root';
new Vue(_editBank2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\bankCard\\editBank.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a77a0352"
...
exports.default = {
    ...
    methods: {
        viewstart: function viewstart() {
            var _this = this;
            storage.getItem('choose_bank', function (event) {
                if (event.data) {
                    _this.bank_name = JSON.parse(event.data).name;
                    _this.bank_code = JSON.parse(event.data).code;
                }
            });
        ...
        alterCode: function alterCode() {
            this.jumpTo2('other/codeHelp', '', { mobile: this.applyMobile, type: this.applyMobile });
        },
        chooseBank: function chooseBank() {
            this.jumpTo2('personal/bankCard/bankLv', '', { bank_name: this.bank_name });
        },
        sendCode: function sendCode(isClick) {
            ...
            var replaceMobile = _this.applyMobile.replace('+', '%2B');
        ...
        isValueParam: function isValueParam() {
            var _this = this;
            if (_this.user_name == "") {
                promptModule.showPrompt({ msg: '请输入户名', type: 'prompt' });
                return true;
            }
            if (_this.bank_code == "") {
                promptModule.showPrompt({ msg: '请选择银行', type: 'prompt' });
                return true;
            }
            if (_this.bank_branch_name == "") {
                promptModule.showPrompt({ msg: '请输入支行名称', type: 'prompt' });
                return true;
            }
            if (_this.bank_no == "") {
                promptModule.showPrompt({ msg: '请输入银行卡号', type: 'prompt' });
                return true;
            }
            if (_this.code == "") {
        ...
        commitBank: function commitBank() {
            var _this = this;
            if (_this.isValueParam()) return;
            loadingModule.show({ msg: '正在编辑...' });
            _this.Post(_this.api().add_bankcard, {
                bank_code: _this.bank_code,
                bank_name: _this.bank_branch_name,
                code: _this.code,
                card_no: _this.bank_no,
    ...
    created: function created() {
        ...
        this.applyMobile = this.GetUrlPara(weex.config.bundleUrl, 'mobile');
        storage.setItem('send_voice', 'false', function (event) {
            if (event.result == 'success') {}
        });
        storage.setItem('choose_bank', null, function (event) {
            if (event.result == 'success') {}
        });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "input": function($event) {
        _vm.user_name = $event.target.attr.value
      }
    }
  })]), _c('line'), _c('div', {
    staticClass: ["item_bank"],
    on: {
    ...
    staticClass: ["choose_bank"]
  }, [_c('text', {
    staticClass: ["bank_name"]
  }, [_vm._v(_vm._s(_vm.bank_name))]), _c('image', {
    staticClass: ["choose_bank_img"],
    attrs: {
    ...
    ref: "bank_branch_name",
    staticClass: ["content"],
    attrs: {
      "type": "text",
      "placeholder": "请输入支行名称",
      "value": (_vm.bank_branch_name)
    },
    on: {
      "input": function($event) {
        _vm.bank_branch_name = $event.target.attr.value
      }
    }
  })]), _c('line'), _c('div', {
    staticClass: ["item"]
    ...
    on: {
      "input": function($event) {
        _vm.bank_no = $event.target.attr.value
      }
    }
  })]), _c('line'), _c('div', {
    staticClass: ["item"]
  ...
  }, [_vm._v(_vm._s(_vm.applyMobile))])]), _c('line'), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.codeName))])]), _c('line'), (_vm.is_show) ? _c('text', {
    staticClass: ["voice_hint"]
  }, [_vm._v("*验证码已发送至" + _vm._s(_vm.applyMobile) + ",请注意接听")]) : _vm._e(), _c('text', {
    staticClass: ["edit"],
    on: {
      "click": function($event) {
        _vm.commitBank()
