...
var _bankInfo = __webpack_require__(2);

var _bankInfo2 = _interopRequireDefault(_bankInfo);
...
_bankInfo2.default.el = '#root';
new Vue(_bankInfo2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\bankCard\\bankInfo.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-421bcc0a"
    ...
    methods: {
        fetch: function fetch() {
            ...
            _this.Get(_this.api().user_finance, {}, function (res) {
                if (res.data.code == '0') {
                    _this.user_name = res.data.data.bank.name;
                    _this.bank_name = res.data.data.bank.bank_name;
                    _this.bank_branch_name = res.data.data.bank.bank_branch_name;
                    _this.bank_no = res.data.data.bank.bank_no;
                } else promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
            });
        },
        editBank: function editBank() {
            this.jumpTo2('personal/finance/financeReason', '', { mobile: this.mobile, type: this.type });
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.user_name))])]), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("银行")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.bank_name))])]), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("支行")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.bank_branch_name))])]), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("卡号")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.bank_no))])]), _c('line'), _c('text', {
    staticClass: ["edit"],
    on: {
