...
var _rechargeUpgradeLevel = __webpack_require__(2);

var _rechargeUpgradeLevel2 = _interopRequireDefault(_rechargeUpgradeLevel);
...
_rechargeUpgradeLevel2.default.el = '#root';
new Vue(_rechargeUpgradeLevel2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\recharge\\rechargeUpgradeLevel.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-35db0525"
...
exports.default = {
    ...
    methods: {
        clickItem: function clickItem(id, update) {
            if (update == 0) return;
            this.jumpTo2('personal/recharge/rechargeLevelConfirm', '', { id: id });
        },
        fetch: function fetch() {
            var self = this;
            self.Get(self.api().updata_level, {}, function (res) {
                if (res.data.code == 0) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('cell', {
    ...
    }, [(item.update == 1 && item.id == 5) ? _c('div', {
      staticClass: ["level-item"],
      on: {
        "click": function($event) {
          _vm.clickItem(item.id, item.update)
        }
      }
    }, [_c('text', {
      ...
      staticClass: ["level-money"]
    }, [_vm._v(_vm._s(item.apply_money))]), _c('image', {
      staticClass: ["next"],
      attrs: {
        "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
      }
    })])]) : _vm._e(), (item.update == 1 && item.id == 5) ? _c('line') : _vm._e()], 1)
  }))], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
