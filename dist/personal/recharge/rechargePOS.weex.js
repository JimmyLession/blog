...
var _rechargePOS = __webpack_require__(2);

var _rechargePOS2 = _interopRequireDefault(_rechargePOS);
...
_rechargePOS2.default.el = '#root';
new Vue(_rechargePOS2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\recharge\\rechargePOS.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-19923cf2"
...
exports.default = {
    ...
    methods: {
        wxcMinibarLeftButtonClicked: function wxcMinibarLeftButtonClicked() {
            event.postMessage(this.eventBusTag().REFRESH_WALLET);
            this.kill(2);
        }
    },
    created: function created() {
        ...
        _this.isIpx(_this);
        _this.money = _this.GetUrlPara(weex.config.bundleUrl, 'money');
        _this.recharge_sn = _this.GetUrlPara(weex.config.bundleUrl, 'recharge_sn');
        _this.user_name = _this.GetUrlPara(weex.config.bundleUrl, 'user_name');
        _this.barcodeUrl = _this.GetUrlPara(weex.config.bundleUrl, 'img_url');
        if (weex.config.env.platform.toLowerCase() === 'android') {
            utilModule.eventListener(function () {});
            var globalEvent = weex.requireModule('globalEvent');
            globalEvent.addEventListener("geolocation", function (e) {
                event.postMessage(_this.eventBusTag().REFRESH_WALLET);
                _this.kill(2);
            });
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["pos-money-title"]
  }, [_vm._v("付款金额")]), _c('text', {
    staticClass: ["pos-money"]
  }, [_vm._v("¥" + _vm._s(_vm.money))])]), _c('text', {
    staticClass: ["pos_user"]
  }, [_vm._v("当前用户：" + _vm._s(_vm.user_name))]), _c('text', {
    staticClass: ["pos_sn"]
  }, [_vm._v("充值编号：" + _vm._s(_vm.recharge_sn))]), _c('image', {
    staticStyle: {
      width: "633px",
      height: "285px",
      marginTop: "58.5px",
    ...
    staticClass: ["pos_sn_info"]
  }, [_vm._v(_vm._s(_vm.recharge_sn))]), _c('text', {
    staticClass: ["pos-des"]
  }, [_vm._v("*只允许公司线下活动当场使用")])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
