...
var _rechargeBindSuccess = __webpack_require__(2);

var _rechargeBindSuccess2 = _interopRequireDefault(_rechargeBindSuccess);
...
_rechargeBindSuccess2.default.el = '#root';
new Vue(_rechargeBindSuccess2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\recharge\\rechargeBindSuccess.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5b1ab78e"
...
exports.default = {
    ...
    methods: {
        finish: function finish() {
            var _this = this;
            if (_this.isset_pay_password) {
                event.postMessage(_this.eventBusTag().REFRESH_RECHARGE);
                _this.kill(2);
            } else {
                _this.jumpTo2('personal/recharge/setPayPassword', '', { type: 'set', mobile: _this.mobile, price: _this.title, password: '' });
            }
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["success_image"],
    attrs: {
      "src": "assets://icon_approve_success"
    }
  }), _c('text', {
    staticClass: ["success_text"]
  }, [_vm._v("恭喜您 您的银行卡已绑定成功")]), _c('text', {
    staticClass: ["ok"],
    on: {
