...
var _useRecord = __webpack_require__(2);

var _useRecord2 = _interopRequireDefault(_useRecord);
...
_useRecord2.default.el = '#root';
new Vue(_useRecord2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\myVoucher\\useRecord.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-29012a02"
...
exports.default = {
    ...
    filters: {
        imgSrc: function imgSrc(value) {
            ...
            switch (value) {
                case -1:
                    return 'http://static.t.abmau.com/assets/img/h5/coupon/noCoupon_bg03.png';
                    break;
                case 4:
                    return 'http://static.t.abmau.com/assets/img/h5/coupon/noCoupon_bg02.png';
                    break;
                case 5:
                    return 'http://static.t.abmau.com/assets/img/h5/coupon/noCoupon_bg03.png';
                    break;
    ...
    methods: {
        useRoules: function useRoules() {
            //点击进入——>使用规则
            modal.toast({ message: 1, duration: 3 });
        }
    },
    created: function created() {
        ...
        _this.Get(_this.api().coupon_used, {
            ...
            if (res.data.code != '0') {
                ...
                //请求数据成功
                _this.data = res.data.data; //使用记录的列表
            }
        });
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.version) ? _c('title', {
    ...
    }, [_vm._v(_vm._s(itemData.title))]), _c('text', {
      class: ['effective-date', 'color' + itemData.coupon_provider_level]
    }, [_vm._v("有效日期至" + _vm._s(itemData.end_at))]), _c('text', {
      class: ['use', 'color' + itemData.coupon_provider_level]
    }, [_vm._v(_vm._s(itemData.give_user_name))]), _c('div', {
    ...
    }, [_vm._v(_vm._s(_vm._f("amountFilters")(itemData.amount)) + _vm._s(_vm._f("typeFilters")(itemData.type)))])])])
  }), _c('cell', {
    staticClass: ["last"],
    appendAsTree: true,
    attrs: {
  ...
  })], 2) : _vm._e(), (_vm.data.length == 0) ? _c('div', {
    staticClass: ["parent"],
    style: {
      top: 0 + 'px',
      bottom: _vm.bottom + 'px'
