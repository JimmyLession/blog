...
var _applyRecord = __webpack_require__(2);
...
_applyRecord2.default.el = '#root';
new Vue(_applyRecord2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\myVoucher\\applyRecord.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b1a1f734"
...
var stream = weex.requireModule('stream'); //stream模块
//
//
//
//
...
var modal = weex.requireModule('modal'); //modal模块
...
exports.default = {
    ...
    methods: {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().apply_coupon_list, {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.version) ? _c('title', {
    ...
    }, [_vm._v(_vm._s(item.title) + " " + _vm._s(item.apply_num) + "张")]), _c('text', {
    ...
    }, [_vm._v(_vm._s(item.status))]), (item.status == '已通过') ? _c('text', {
      staticClass: ["level-fact_num"]
    }, [_vm._v("实发" + _vm._s(item.fact_num) + "张")]) : _vm._e()])])]) : _vm._e()
