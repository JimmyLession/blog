...
var _present = __webpack_require__(2);
...
_present2.default.el = '#root';
new Vue(_present2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\myVoucher\\present.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6d6cad42"
...
var _searchbar = __webpack_require__(9);
...
exports.default = {
    components: {
        pop: _pop2.default, WxcSearchbar: _searchbar2.default
    },
    data: function data() {
        return {
            bgImgSrc: '',
    ...
    methods: {
        wxcSearchbarCancelClicked: function wxcSearchbarCancelClicked(data) {
            //点击搜索按钮
            var _this = this;
        ...
        wxcSearchbarCloseClicked: function wxcSearchbarCloseClicked(data) {
            var _this = this;
            _this.searchValue = data.value;
            this.$refs['wxc-searchbar'].autoBlur();
            _this.list = [];
        ...
        fetch: function fetch() {
            ...
            _this.Get(_this.api().coupon_given_list, {
                // token : 'ab3a2e036758a1d225de15ab61f90f73',
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\components\\searchbar.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-44c433ac"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "wxcSearchbarInputOnBlur": _vm.wxcSearchbarCancelClicked,
    ...
    return _c('cell', {
      ...
      staticClass: ["img"],
      attrs: {
        "src": "https://ss2.baidu.com/6ONYsjip0QIZ8tyhnq/it/u=3689381372,2613239640&fm=58"
      }
    })]), _c('div', {
      staticClass: ["info"]
    }, [_c('text', {
    ...
    }, [_vm._v(_vm._s(item.level_name))])])])])
  }), (_vm.loading) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  }, [_vm._m(0)]) : _vm._e(), (_vm.mask) ? _c('pop', {
    attrs: {
      "name": _vm.name,
      "mobile": _vm.mobile,
      "canGive": _vm.canGive,
