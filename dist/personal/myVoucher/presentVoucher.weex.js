...
var _presentVoucher = __webpack_require__(2);

var _presentVoucher2 = _interopRequireDefault(_presentVoucher);
...
_presentVoucher2.default.el = '#root';
new Vue(_presentVoucher2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\myVoucher\\presentVoucher.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6aab1788"
...
var _pop = __webpack_require__(5);
...
exports.default = {
    components: {
        title: _titleBar2.default, pop: _pop2.default, WxcSearchbar: _search2.default, empty: _empty2.default
    },
    data: function data() {
        return {
            bottom: bottom,
    ...
    methods: {
        ...
        fetch: function fetch() {
            ...
            _this.Get(_this.api().coupon_given_list, {
                limit: _this.limit,
                offset: _this.offset,
                key_word: encodeURIComponent(_this.searchValue)
            }, function (res) {
                if (res.data.code == 0) {
                    _this.isStart = false;
                    var listData = JSON.stringify(res.data.data);
                    _this.isResquesting = false;
                    if (res.data._count == 0) _this.showEmpty = true;else _this.showEmpty = false;
                    if (res.data._count > _this.offset) {
                        _this.offset += 10;
                        _this.allLoadingFinsh = false;
                    } else {
                        _this.loading = true;
                        _this.allLoadingFinsh = true;
                    }
        ...
        choose: function choose(value) {
            ...
            this.headImg = value.head_img;
            this.canGive = value.can_give;
        },
        ...
        submit: function submit() {
            var _this = this;
            _this.Get(_this.api().given_coupon, {
                id_code: _this.pop.id_code,
                ...
                if (res.ok) {
                    if (res.data != null) {
                        if (res.data.code != '0') {
                            ...
                            //赠送成功
                            modal.toast({ message: res.data.msg, duration: 5 });
                            _this.upDate(); //赠送成功之后返回到我的券的页面并刷新
                        }
                    } else {
                        modal.toast({ message: '网络异常', duration: 5 });
                    }
                    _this.popBar(); //返回前一个页面 
                }
            });
        }
    },
    created: function created() {
        ...
        this.isIpx(this);
        this.user_coupon_id = this.GetUrlPara(weex.config.bundleUrl, 'user_coupon_id');
        this.user_title = this.GetUrlPara(weex.config.bundleUrl, 'title');
        this.user_time = this.GetUrlPara(weex.config.bundleUrl, 'time');
        //console.log('--------------创建fetch请求offset:'+ this.offset);
        this.fetch();
        var _this = this;
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\components\\pop.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-105ce950"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    props: ['name', 'mobile', 'headImg', 'userTime', 'userTitle', 'canGive'],
    data: function data() {
        return {
            height: height
        };
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.headImg != '' && _vm.headImg != null) ? _c('image', {
    staticClass: ["img"],
    attrs: {
      "resize": "cover",
      "src": _vm.headImg
    }
  }) : _vm._e(), (_vm.headImg == '' || _vm.headImg == null) ? _c('image', {
    staticClass: ["img"],
    attrs: {
      "resize": "cover",
    ...
    staticClass: ["info-detail", "name"],
    attrs: {
      "lines": "1"
    }
  }, [_vm._v(_vm._s(_vm.name))]), _c('text', {
    staticClass: ["info-detail", "mobile"],
    attrs: {
      "lines": "1"
    }
  }, [_vm._v(_vm._s(_vm.mobile))])])]), _c('div', {
    staticClass: ["coupon"]
  }, [(_vm.canGive == 1) ? _c('text', {
    staticClass: ["ctn"]
  }, [_vm._v(_vm._s(_vm.userTitle))]) : _vm._e(), (_vm.canGive == 1) ? _c('text', {
    staticClass: ["time"]
  }, [_vm._v(_vm._s(_vm.userTime) + "前有效")]) : _vm._e(), (_vm.canGive != 1) ? _c('text', {
    staticClass: ["cannot-give"]
  }, [_vm._v("不允许赠送,对方半年内曾使用过或已拥有该类型券")]) : _vm._e()])]), (_vm.canGive == 1) ? _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
  ...
  })], 1), _vm._l((_vm.list), function(item, i) {
    return (_vm.list.length != 0) ? _c('cell', {
      ...
      staticClass: ["item-panel", "coupon1"],
      attrs: {
        "value": item.id_code
      },
      on: {
      ...
      staticClass: ["head-img"]
    }, [(item.head_img != '' && item.head_img != null) ? _c('image', {
      staticClass: ["img"],
      attrs: {
        "resize": "cover",
        "src": item.head_img
      }
    }) : _vm._e(), (item.head_img == '' || item.head_img == null) ? _c('image', {
      staticClass: ["img"],
      attrs: {
        "resize": "cover",
        "src": "assets://icon_user_placehold"
      ...
      staticClass: ["level-txt"]
    }, [_vm._v(_vm._s(item.level_name))])])])]) : _vm._e()
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.loading && _vm.list.length > 8) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["loading-over-txt"]
  }, [_vm._v("已经全部加载完毕")]) : _vm._e()])]) : _vm._e(), (_vm.mask) ? _c('pop', {
    attrs: {
      "name": _vm.name,
      "mobile": _vm.mobile,
      "canGive": _vm.canGive,
      "userTitle": _vm.user_title,
      "userTime": _vm.user_time,
      "headImg": _vm.headImg
    },
    on: {
      "close": _vm.closeMask,
