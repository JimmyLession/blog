...
var _useRules = __webpack_require__(2);

var _useRules2 = _interopRequireDefault(_useRules);
...
_useRules2.default.el = '#root';
new Vue(_useRules2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\myVoucher\\useRules.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-45e63e8e"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._m(0), _vm._m(1), _vm._m(2), _vm._m(3), _vm._m(4), _c('cell', {
    staticClass: ["last"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
  ...
  return _c('cell', {
    ...
    staticClass: ["Qtext"]
  }, [_vm._v("什么是体验券？")])]), _c('div', {
    staticClass: ["firstA"]
  }, [_c('text', {
    staticClass: ["A"]
  }, [_vm._v("A   ")]), _c('text', {
    staticClass: ["Atext"]
  }, [_vm._v("体验券是发放给经销商在订货时用于体验体系内各等级特权的电子券")])])])
  ...
  return _c('cell', {
    ...
    staticClass: ["Qtext"]
  }, [_vm._v("使用体验券有哪些好处？")])]), _c('div', {
    staticClass: ["firstA"]
  }, [_c('text', {
    staticClass: ["A"]
  }, [_vm._v("A   ")]), _c('text', {
    staticClass: ["Atext"]
  }, [_vm._v("在订单支付时使用体验券，可以享受该券上对应等级经销商几乎同等相关的权益。\n例如会员在订单支付时使用中级经销商体验券，可直接享受中级经销商折扣购买商品，同时该笔订单相关收益结算时亦视为中级经销商对待。")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('cell', {
    staticClass: ["cell"],
    appendAsTree: true,
    ...
    staticClass: ["Qtext"]
  }, [_vm._v("一个订单最多能够使用几张体验券？")])]), _c('div', {
    staticClass: ["firstA"]
  }, [_c('text', {
    staticClass: ["A"]
  }, [_vm._v("A   ")]), _c('text', {
    staticClass: ["Atext"]
  }, [_vm._v("一个订单最多能够使用一张体验券。订购多个商品（包括活动套餐）时可选择先加购物车后一起支付。")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('cell', {
    staticClass: ["cell"],
    appendAsTree: true,
    ...
    staticClass: ["Qtext"]
  }, [_vm._v("预售产品和活动套装是否可以使用特权券？")])]), _c('div', {
    staticClass: ["firstA"]
  }, [_c('text', {
    staticClass: ["A"]
  }, [_vm._v("A   ")]), _c('text', {
    staticClass: ["Atext"]
  }, [_vm._v("除入门产品或特别说明的部分商品不能使用外，均可使用券，但仅限在app内使用。")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('cell', {
    staticClass: ["cell"],
    appendAsTree: true,
    ...
    staticClass: ["Qtext"]
  }, [_vm._v("体验券是否可以赠送？")])]), _c('div', {
    staticClass: ["firstA"]
  }, [_c('text', {
    staticClass: ["A"]
  }, [_vm._v("A   ")]), _c('text', {
    staticClass: ["Atext"]
  }, [_vm._v("体验券仅支持由邀请人赠送给被邀请人（被邀请人可以是直属下级或同级，以实际绑定的邀请码为准），其他情况不支持赠送")])])])
}]}
module.exports.render._withStripped = true
