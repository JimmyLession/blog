...
var _personalInfoCode = __webpack_require__(2);

var _personalInfoCode2 = _interopRequireDefault(_personalInfoCode);
...
_personalInfoCode2.default.el = '#root';
new Vue(_personalInfoCode2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\personalInfoCode.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-8a322dac"
...
exports.default = {
    ...
    methods: {
        //上传二维码
        updateWeixinPhoto: function updateWeixinPhoto() {

            var _this = this;
            var titlesDict = { 'photoFile': '从手机相册选择' };

            comModal.uploadPhoto({ 'titlesDict': titlesDict, 'save_imageUrl': '' }, function (ret) {
                if (!ret.url) {
                    promptModule.showPrompt({ msg: '获取图片链接失败', type: 'err' });return;
                }
                _this.Post(_this.api().personal_updateImage, { 'qr_code_url': ret.url }, function (res) {
                    if (res.data.code == '0') {
                        _this.qr_code_url = ret.url;
                        promptModule.showPrompt({ msg: '上传成功', type: 'success' });
                    } else {
    ...
    created: function created() {
        ...
        self.isIpx(self);
        self.qr_code_url = self.GetUrlPara(weex.config.bundleUrl, 'qr_code_url');
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["wei_img"]
  }, [(_vm.qr_code_url == '') ? _c('image', {
    staticClass: ["wei_img_photo"],
    attrs: {
      "src": "assets://icon_empty_wechat_card"
    }
  }) : _vm._e(), (_vm.qr_code_url != '') ? _c('image', {
    staticClass: ["wei_img_photo"],
    attrs: {
      "src": _vm.qr_code_url
    }
