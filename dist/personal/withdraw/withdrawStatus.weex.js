...
var _withdrawStatus = __webpack_require__(2);

var _withdrawStatus2 = _interopRequireDefault(_withdrawStatus);
...
_withdrawStatus2.default.el = '#root';
new Vue(_withdrawStatus2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\withdraw\\withdrawStatus.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5af02c6f"
...
exports.default = {
    ...
    created: function created() {
        ...
        this.rechargeMoney = this.GetUrlPara(weex.config.bundleUrl, 'rechargeMoney');
        this.goods_payment = this.GetUrlPara(weex.config.bundleUrl, 'goods_payment');
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["image"],
    attrs: {
      "src": "assets://icon_withdraw_success"
    }
  }), _c('text', {
    staticClass: ["title"]
  }, [_vm._v("提现申请已受理")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v("我们会在3-5个工作日（不含当日）内将款项汇出，短信通知，请注意查收")])]) : _vm._e(), (_vm.type == 0) ? _c('div', {
    staticClass: ["balance"]
  }, [_c('image', {
    staticClass: ["image"],
    attrs: {
    ...
    staticClass: ["content"]
  }, [_vm._v("成功转出" + _vm._s(_vm.rechargeMoney) + "元至货款余额，当前货款余额" + _vm._s(_vm.goods_payment) + "元")])]) : _vm._e()])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
