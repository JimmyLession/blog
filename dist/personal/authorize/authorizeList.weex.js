...
var _authorizeList = __webpack_require__(2);

var _authorizeList2 = _interopRequireDefault(_authorizeList);
...
_authorizeList2.default.el = '#root';
new Vue(_authorizeList2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\authorize\\authorizeList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9669d796"
...
exports.default = {
    ...
    methods: {
        getData: function getData() {
            var _this = this;
            if (!_this.mobile) {
                utilModule.getMobile(function (event) {
                    if (event.mobile) {
        ...
        getAuthorizeList: function getAuthorizeList() {
            var _this = this;
            _this.utilGet(_this.api().user_brand, {
        ...
        clickTo: function clickTo(item) {
            var type = void 0;
            if (!item.type && item.type != 0 && !item.refund_status && item.refund_status != 0) {
                type = 0; //未申请
            } else if (item.refund_status == 0 || item.refund_status) {
                type = 1; //退款状态
            } else {
                type = 2; //授权状态
            }
            this.jumpTo2('personal/authorize/authorizeDetails', '', { mobile: this.mobile, brandId: item.brand_id, type: type });
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    }, [_vm._v(_vm._s(item.name))]), (item.refund_status) ? _c('div', {
      staticClass: ["home_li_triangle"]
    }, [(item.refund_status == 1 || item.refund_status == 3) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("退款中")]) : _vm._e(), (item.refund_status == 2) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("退款失败")]) : _vm._e(), (item.refund_status == 4) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("已退款")]) : _vm._e(), _c('image', {
      staticClass: ["triangle"],
      attrs: {
        "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
      }
    })]) : _vm._e(), ((item.type == 0 || item.type) && !item.refund_status) ? _c('div', {
      staticClass: ["home_li_triangle"]
    }, [(item.type == 0) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("待支付")]) : _vm._e(), (item.type == 1) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("审核中")]) : _vm._e(), (item.type == 2) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("已拒绝")]) : _vm._e(), (item.type == 3) ? _c('text', {
      staticClass: ["home_li_status"]
    }, [_vm._v("已授权")]) : _vm._e(), _c('image', {
      staticClass: ["triangle"],
      attrs: {
        "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
      }
    })]) : _vm._e(), (!item.type && item.type != 0 && !item.refund_status && item.refund_status != 0) ? _c('div', {
      staticClass: ["home_li_triangle"]
    }, [_c('text', {
      staticClass: ["home_li_status"],
      style: {
