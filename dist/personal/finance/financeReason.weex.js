...
var _financeReason = __webpack_require__(2);

var _financeReason2 = _interopRequireDefault(_financeReason);
...
_financeReason2.default.el = '#root';
new Vue(_financeReason2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\finance\\financeReason.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7484e73d"
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            type: '',
            webHeight: 10,
            html: "<div style='list-style: none;padding: 0;margin: 0'>\n" + "       <li style='position: relative;font-size: 36px;line-height:48px;color: #333333;margin-top: 25px;padding-left: 28px;'><span style='display:inline-block;width: 12px;height: 12px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 18px;left: 0px;'></span>存折、信用卡、虚拟银行卡账号不能进行绑定，<u style='font-weight: bold;'>只能是借记卡</u>；</li>\n" + "       <li style='position: relative;font-size: 36px;line-height:48px;color: #333333;margin-top: 25px;padding-left: 28px;'><span style='display:inline-block;width: 12px;height: 12px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 18px;left: 0px;'></span>银行卡号<u style='font-weight: bold;'>只能是数字组成</u>，不能包含空格、“-”等非数字符号，输入时请仔细检查;</li>\n" + "       <li style='position: relative;font-size: 36px;line-height:48px;color: #333333;margin-top: 25px;padding-left: 28px;'><span style='display:inline-block;width: 12px;height: 12px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 18px;left: 0px;'></span>持卡人名字必须与银行卡开卡名字保持一致,如果持卡人名字是拼音，请注意大小写必须和开户时一致;</li>\n" + "       <li style='position: relative;font-size: 36px;line-height:48px;color: #333333;margin-top: 25px;padding-left: 28px;'><span style='display:inline-block;width: 12px;height: 12px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 18px;left: 0px;'></span>目前单创系统只支持国内大部分的银行卡绑定，不支持国外银行卡;</li>\n" + "       <li style='position: relative;font-size: 36px;line-height:48px;color: #333333;margin-top: 25px;padding-left: 28px;'><span style='display:inline-block;width: 12px;height: 12px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 18px;left: 0px;'></span>无法完成绑定流程的客户，<u style='font-weight: bold;'>请详细核对开卡信息</u>。若仍无法完成绑定，请联系客服;</li>\n" + "   </div>",
            iosHtml: "<ul style='list-style: none;padding: 0;margin: 0'>\n" + "       <li style='position: relative;font-size: 14px;color: #333333;margin-top: 10px;padding-left: 14px;'><span style='display:inline-block;width: 6px;height: 6px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 8px;left: 0px;'></span>存折、信用卡、虚拟银行卡账号不能进行绑定，<u style='font-weight: 600;'>只能是借记卡</u>；</li>\n" + "       <li style='position: relative;font-size: 14px;color: #333333;margin-top: 10px;padding-left: 14px;'><span style='display:inline-block;width: 6px;height: 6px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 8px;left: 0px;'></span>银行卡号<u style='font-weight: 600;'>只能是数字组成</u>，不能包含空格、“-”等非数字符号，输入时请仔细检查;</li>\n" + "       <li style='position: relative;font-size: 14px;color: #333333;margin-top: 10px;padding-left: 14px;'><span style='display:inline-block;width: 6px;height: 6px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 8px;left: 0px;'></span>持卡人名字必须与银行卡开卡名字保持一致,如果持卡人名字是拼音，请注意大小写必须和开户时一致;</li>\n" + "       <li style='position: relative;font-size: 14px;color: #333333;margin-top: 10px;padding-left: 14px;'><span style='display:inline-block;width: 6px;height: 6px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 8px;left: 0px;'></span>目前单创系统只支持国内大部分的银行卡绑定，不支持国外银行卡;</li>\n" + "       <li style='position: relative;font-size: 14px;color: #333333;margin-top: 10px;padding-left: 14px;'><span style='display:inline-block;width: 6px;height: 6px;background-color: #333333;transform: rotate(45deg);position: absolute;top: 8px;left: 0px;'></span>无法完成绑定流程的客户，<u style='font-weight: 600;'>请详细核对开卡信息</u>。若仍无法完成绑定，请联系客服;</li>\n" + "   </ul>"
        };
    },

    methods: {
        bindCard: function bindCard() {
            this.jumpTo2('personal/finance/addBankCard', '', { title: '添加银行卡', mobile: this.mobile, type: this.type });
        },
        loadFinish: function loadFinish(e) {
            this.show = true;
            this.webHeight = e.height;
        },
    ...
    created: function created() {
        ...
        _this.isIos = weex.config.env.platform.toLowerCase() === 'ios';
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["web_text"],
    attrs: {
      "src": "http://img.abmau.com/abmau/2345072ac81413df3d377b757c66c56c.png"
    }
  }), _c('text', {
