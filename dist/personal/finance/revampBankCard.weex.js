...
var _revampBankCard = __webpack_require__(2);

var _revampBankCard2 = _interopRequireDefault(_revampBankCard);
...
_revampBankCard2.default.el = '#root';
new Vue(_revampBankCard2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\finance\\revampBankCard.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0fd9c4de"
...
exports.default = {
    ...
    methods: {
        ...
        editBank: function editBank() {
            this.jumpTo2('personal/finance/addBankCard', '', { title: '编辑银行卡', mobile: this.mobile, type: this.type });
        }
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.newBank.name))])]), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("银行")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.newBank.bank_name))])]), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["title"]
  }, [_vm._v("卡号")]), _c('text', {
    staticClass: ["content"]
  }, [_vm._v(_vm._s(_vm.newBank.bank_no))])]), _c('line'), _c('text', {
    staticClass: ["edit"],
    on: {
  ...
  }, [_vm._v("修改")]), (_vm.type == 'edit') ? _c('text', {
    staticClass: ["edit"],
    on: {
      "click": function($event) {
        _vm.editBank()
