...
var _addBankCard = __webpack_require__(4);

var _addBankCard2 = _interopRequireDefault(_addBankCard);
...
_addBankCard2.default.el = '#root';
new Vue(_addBankCard2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\finance\\addBankCard.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-447a45ec"
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            isBind: true,
            isParam: false,
            isForeignParam: false
        };
    },

    methods: {
        inputForeignCard: function inputForeignCard(e) {
            this.foreign_card_no = e.value;
            this.isForeignParam = this.isValueParam(this, [this.foreign_card_no, this.foreign_nick_name, this.passport]);
        },
        inputForeignName: function inputForeignName(e) {
            this.foreign_nick_name = e.value;
            this.isForeignParam = this.isValueParam(this, [this.foreign_card_no, this.foreign_nick_name, this.passport]);
        },
        inputCard: function inputCard(e) {
            this.card_no = e.value;
            this.isParam = this.isValueParam(this, [this.card_no, this.nick_name]);
        },
        inputName: function inputName(e) {
            this.nick_name = e.value;
            this.isParam = this.isValueParam(this, [this.card_no, this.nick_name]);
        },
        ...
        inputIDCard: function inputIDCard(e) {
            this.id_card_no = e.value;
            this.checkParams();
        },
        inputPassport: function inputPassport(e) {
            this.passport = e.value;
            this.isForeignParam = this.isValueParam(this, [this.foreign_card_no, this.foreign_nick_name, this.passport]);
        },

        //检测输入参数
        checkParams: function checkParams() {
            if (this.card_no.length > 0 && this.nick_name.length > 0 && this.id_card_no.length > 0) {
                this.isRed = true;
            } else {
                this.isRed = false;
            }
        ...
        //点击 不能绑卡？
        notBindCard: function notBindCard() {
            this.jumpTo2('personal/finance/financeReminder', '', { type: this.type, mobile: this.mobile });
        },
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().bank_info, {}, function (res) {
                if (res.data.code == 0) {
                    /*_this.card_no = res.data.data.bank_info.bank_no;
                    _this.nick_name = res.data.data.bank_info.name;*/
                    //_this.id_card_no = res.data.data.bank_info.id_card;
                    _this.isBind = res.data.data.bind_new_bank;
                    /*_this.$refs.card_no.setDefaultValue(_this.card_no);
                    _this.$refs.nick_name.setDefaultValue(_this.nick_name);*/
                    //_this.$refs.id_card_no.setDefaultValue(_this.id_card_no);
        ...
        //提交绑定银行卡
        commit: function commit(card_no, nick_name, passport) {
            var _this = this;
            loadingModule.show({ msg: '' });
            _this.Post(_this.api().bindCard, {
                name: nick_name,
                bank_no: card_no,
                id_card: passport
            }, function (res) {
                loadingModule.cancel(function (ret) {
                    ...
                    if (result == 'dismiss') {
                        if (res.data.code == 0) {
                            event.postMessage(_this.eventBusTag().EDIT_BANK_SUCCESS);
                            promptModule.showListener({ msg: '提交成功', type: 'success' }, function (e) {
                                _this.interceptPush('personal/finance/addBankStatus', { type: _this.type }, 'intercept');
                            });
                        } else {
    ...
    created: function created() {
        ...
        _this.str_title = _this.GetUrlPara(weex.config.bundleUrl, 'title');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    return _c('list', {
    ...
    }, [_vm._v("信息加密处理，保障个人隐私不泄露")])]), _c('div', {
      ...
      on: {
        "onInput": _vm.inputName
      }
    })], 1), _c('line'), (false) ? _c('div', {
      staticClass: ["edit-item"]
    }, [_c('text', {
      staticClass: ["edit-item-title"]
    }, [_vm._v("身份证")]), _c('edit', {
      ...
      on: {
        "onInput": _vm.inputIDCard
      }
    })], 1) : _vm._e(), (false) ? _c('text', {
      style: {
        lineHeight: 70 + 'px',
        backgroundColor: '#f6f6f6',
        color: '#666666',
    ...
    }, [_vm._v("请填写真实有效的身份信息")]) : _vm._e(), _c('wx-button', {
      attrs: {
        "marginTop": "98",
        "content": "提交",
      ...
      on: {
        "onClick": function($event) {
          _vm.commit(_vm.card_no, _vm.nick_name, '')
        }
      }
    }), _c('div', {
      staticClass: ["not_bindCard_bg"]
    }, [_c('text', {
      staticClass: ["not_bindCard_text"],
      on: {
        "click": function($event) {
          _vm.notBindCard()
        }
      }
    }, [_vm._v("无法绑定银行卡？")])])], 1) : _vm._e(), (_vm.selectItem == 1) ? _c('cell', {
      staticClass: ["bank_item"],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      attrs: {
        "type": "text",
        "placeholder": "请输入户名护照号"
      },
      on: {
        "onInput": _vm.inputPassport
      }
    })], 1), _c('line'), (false) ? _c('div', {
      staticClass: ["edit-item"]
    }, [_c('text', {
      ...
      attrs: {
        "marginTop": "98",
        "content": "提交",
        "isValueParam": _vm.isForeignParam
      },
      on: {
        "onClick": function($event) {
          _vm.commit(_vm.foreign_card_no, _vm.foreign_nick_name, _vm.passport)
        }
      }
    }), _c('div', {
      staticClass: ["not_bindCard_bg"]
