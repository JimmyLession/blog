...
var _businessSchoolIndex = __webpack_require__(2);

var _businessSchoolIndex2 = _interopRequireDefault(_businessSchoolIndex);
...
_businessSchoolIndex2.default.el = '#root';
new Vue(_businessSchoolIndex2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\businessSchool\\businessSchoolIndex.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1cdedf25"
...
var _wxcPopover = __webpack_require__(5);
...
var _refresh = __webpack_require__(19);
...
exports.default = {
    components: { titleBar: _titleBar2.default, refresher: _refresh2.default, line: _line2.default, WxcOverlay: _wxcOverlay2.default, WxcPopover: _wxcPopover2.default },
    data: function data() {
        return {
            popArray: [//在父组件中定义排序的方式
            {
                text: '按发布时间排序',
                key: 'time'
            }, {
            ...
            isShowOrderPop: false, //默认不现实排序黑色背景
            overlayCfg: {
                hasAnimation: true,
    ...
    methods: {
        updateScrollHeright: function updateScrollHeright() {
            ...
            dom.getComponentRect(_this.$refs['header'], function (option) {
        ...
        showPop: function showPop() {
            //显示弹出层
            var _this = this;
            _this.isShowOrderPop = !_this.isShowOrderPop;
        },
        closeOrderPop: function closeOrderPop() {
            //点击的遮罩层的时候影藏整个弹出层
            this.isShowOrderPop = false;
        },
        ...
        clickCategory: function clickCategory(category_id, category_title) {
            this.jumpTo2('personal/businessSchool/businessSchoolLv', '', { category_id: category_id, category_title: category_title }, '');
        },
        ...
        initCategory: function initCategory() {
            var _this = this;
            _this.Get(_this.api().college_category, { sort: 'time', category_id: 0 }, function (res) {
                if (res.data.code == '0') {
                    _this.category = res.data.data;
                    _this.initArticleList();
                } else promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
            });
        },
        initArticleList: function initArticleList() {
            var _this = this;
...
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-18237f92"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.clickCategory(item.category_id, item.category_title)
        }
      }
    }, [_c('image', {
  ...
  }, [_vm._v(_vm._s(_vm.tabText))]), _c('image', {
    staticClass: ["tab_image"],
    attrs: {
      "src": "assets://icon_menu_normal"
    }
  })]), (_vm.isShowOrderPop) ? _c('order-pop', {
    ref: "order-pop",
    attrs: {
  ...
  }) : _vm._e()], 1), (_vm.data.length != 0) ? _c('cell', {
    staticClass: ["article"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
