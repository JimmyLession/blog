...
var _businessSchoolDetail = __webpack_require__(2);

var _businessSchoolDetail2 = _interopRequireDefault(_businessSchoolDetail);
...
_businessSchoolDetail2.default.el = '#root';
new Vue(_businessSchoolDetail2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\businessSchool\\businessSchoolDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1750150e"
...
exports.default = {
    ...
    methods: {
        error: function error(res) {
            if (this.compareVersion('1.1.0')) this.$refs.web.setReload();
        },
        clickLike: function clickLike(liked) {
            if (liked == 1) return;
            var _this = this;
            _this.Post(_this.api().college_like, { article_id: _this.article_id }, function (res) {
                if (res.data.code == '0') {
                    _this.is_like = 1;
                    _this.article_likes = parseInt(_this.article_likes) + 1;
                    promptModule.showPrompt({ msg: '点赞成功', type: 'success' });
        ...
        //分享
        clickShare: function clickShare(title, desc, url, image) {
            var _this = this;
            ...
            _this.Post(_this.api().college_share, { article_id: _this.article_id }, function (res) {
                _this.article_shares = parseInt(_this.article_shares) + 1;
            });
        },
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().college_article, { article_id: _this.article_id }, function (res) {
                if (res.data.code == '0') {
                    _this.data = res.data.data;
                    _this.is_like = res.data.data.has_liked;
                    _this.article_likes = res.data.data.article_likes;
                    _this.article_shares = res.data.data.article_shares;
                } else promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
            });
        }
    },
    created: function created() {
        var _this = this;
        _this.isIpx(_this);
        _this.article_id = _this.GetUrlPara(weex.config.bundleUrl, 'article_id');
        _this.isVersion = _this.compareVersion('1.1.0');
        _this.fetch();
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm.data.article_url
    },
    on: {
      "error": _vm.error
    }
  }) : _vm._e(), (!_vm.isVersion) ? _c('web', {
    ref: "wv",
    staticClass: ["parent"],
    style: {
      top: 0 + 'px',
    ...
    staticClass: ["article_bottom"]
  }, [_c('div', {
    staticClass: ["read"]
  }, [_c('text', {
    staticClass: ["read_title"]
  }, [_vm._v("阅读")]), _c('text', {
    staticClass: ["read_text"]
  }, [_vm._v(_vm._s(_vm.data.article_views))])]), _c('div', {
    staticClass: ["read"]
  }, [_c('div', {
    staticClass: ["read"],
    on: {
      "click": function($event) {
        _vm.clickLike(_vm.is_like)
      }
    }
  }, [(_vm.is_like == 0) ? _c('image', {
    staticClass: ["like_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/e1fbfca281f8198d6ddbca59c807e805.png"
    }
  }) : _vm._e(), (_vm.is_like == 1) ? _c('image', {
    staticClass: ["like_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/970c1d90f98ed243355f79f1ab7698d9.png"
    }
  }) : _vm._e(), _c('text', {
    staticClass: ["like_text"]
  }, [_vm._v(_vm._s(_vm.article_likes))])]), _c('div', {
    staticClass: ["read"],
    on: {
      "click": function($event) {
        _vm.clickShare(_vm.data.article_share_title, _vm.data.article_share_desc, _vm.data.article_share_url, _vm.data.article_share_thumb)
      }
    }
  }, [_c('image', {
    staticClass: ["share_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/e7c1fc3d23e4999b152ed76d044e6130.png"
    }
  }), _c('text', {
    staticClass: ["share_text"]
  }, [_vm._v(_vm._s(_vm.article_shares))])])])]), _c('image', {
    staticClass: ["finish_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/d17f5e4748b6ecc9f7bd873fde90ad98.png"
    },
    on: {
      "click": function($event) {
        _vm.finish()
