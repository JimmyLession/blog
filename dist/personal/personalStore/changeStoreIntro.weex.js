...
var _changeStoreIntro = __webpack_require__(2);

var _changeStoreIntro2 = _interopRequireDefault(_changeStoreIntro);
...
_changeStoreIntro2.default.el = '#root';
new Vue(_changeStoreIntro2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\personalStore\\changeStoreIntro.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-774899b6"
...
exports.default = {
    ...
    methods: {
        commit: function commit() {
            var _this = this;
            if (_this.store_intro == "") {
                promptModule.showPrompt({ msg: '店铺描述不能为空', type: 'prompt' });
                return;
            }
            _this.Post(_this.api().shop_setting, { 'intro': _this.store_intro }, function (res) {
                if (res.data.code == '0') {
    ...
    created: function created() {
        ...
        self.isIpx(self);
        self.store_intro = self.GetUrlPara(weex.config.bundleUrl, 'store_intro');
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["textarea_storeIntro"],
    attrs: {
      "type": "text",
      "maxlength": "40",
      "placeholder": "修改商城简介",
      "value": (_vm.store_intro)
    },
    on: {
      "input": function($event) {
        _vm.store_intro = $event.target.attr.value
      }
    }
  }), _c('div', {
    staticClass: ["text_background"]
  }, [_c('text', {
    staticClass: ["count_text"]
  }, [_vm._v(_vm._s(_vm.store_intro.length))]), _c('text', {
    staticClass: ["content_text"]
  }, [_vm._v(" / 40")])]), _c('line')], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
