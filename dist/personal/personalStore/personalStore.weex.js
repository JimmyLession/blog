...
var _personalStore = __webpack_require__(2);

var _personalStore2 = _interopRequireDefault(_personalStore);
...
_personalStore2.default.el = '#root';
new Vue(_personalStore2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\personalStore\\personalStore.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-7fd821a7"
...
exports.default = {
    ...
    methods: {
        ...
        //分享到微信
        goToShare: function goToShare(type) {
            titleBar.goToAppShare({
                type: type,
                share_url: this.store_url,
                share_name: this.store_name,
                share_intro: this.store_into,
                share_image: this.store_photo
            });
        },


        //预览 我的店铺web界面 商城web界面type='store',其他不用传
        check: function check() {
            titleBar.goToWebStore({
                share_url: this.store_url,
                share_name: this.store_name,
                share_intro: this.store_into,
                share_image: this.store_photo,
        ...
        changeStoreName: function changeStoreName() {
            this.jumpTo2('personal/personalStore/changeStoreName', '', { store_name: this.store_name }, '保存');
        },


        //修改店铺信息
        changeStoreInfo: function changeStoreInfo() {
            this.jumpTo2('personal/personalStore/changeStoreIntro', '', { store_intro: this.store_into }, '保存');
        },


        //上传店铺头像
        changeStorePhoto: function changeStorePhoto() {
            ...
            comModal.uploadPhoto({ 'titlesDict': titlesDict }, function (ret) {
                if (!ret.url) {
                    promptModule.showPrompt({ msg: '获取图片链接失败', type: 'err' });
                    return;
                }
                _this.Post(_this.api().shop_setting, { 'shop_image': ret.url }, function (res) {
                    if (res.data.code == '0') {
                        _this.store_photo = ret.url;
                        promptModule.showPrompt({ msg: '修改成功', type: 'success' });
                    } else {
        ...
        requestData: function requestData() {
            var _this = this;
            _this.Get(_this.api().new_index, {}, function (res) {
                if (res.data.code == '0') {
                    _this.infoData = res.data.data;
                    _this.store_url = res.data.data.share_url;
                    _this.store_name = res.data.data.nickname;
                    _this.store_into = res.data.data.intro;
                    _this.store_photo = res.data.data.shop_image;
                } else {
                    promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                }
            });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["navigator_image"],
    attrs: {
      "src": "assets://icon_share_copy"
    }
  }), _c('text', {
    staticClass: ["navigator_text"]
  }, [_vm._v("复制链接")])])])]), _c('div', {
    staticClass: ["top_background"]
  }), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.store_name))]), _c('image', {
    ...
    staticClass: ["right_content"]
  }, [_vm._v(_vm._s(_vm.store_into))]), _c('image', {
    staticClass: ["form_item_more"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
  })])]), _c('line'), _c('div', {
    staticClass: ["bottom_background"],
    on: {
      "click": function($event) {
        _vm.changeStorePhoto()
      }
    }
  }, [_c('text', {
    staticClass: ["photo_title_name"]
  }, [_vm._v("商城头像")]), _c('div', {
    staticClass: ["right_info"]
  }, [(_vm.store_photo != '') ? _c('image', {
    staticClass: ["photo_img"],
    attrs: {
      "resize": "cover",
      "src": _vm.store_photo
    }
  }) : _vm._e(), (_vm.store_photo == '') ? _c('image', {
    staticClass: ["photo_img"],
    attrs: {
      "resize": "cover",
