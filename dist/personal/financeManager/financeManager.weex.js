...
var _financeManager = __webpack_require__(2);

var _financeManager2 = _interopRequireDefault(_financeManager);
...
_financeManager2.default.el = '#root';
new Vue(_financeManager2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\financeManager\\financeManager.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2f7a26fd"
...
module.exports = {
  ...
  "content-balance-payment-h": {
    "width": "684",
    "flexDirection": "row",
    "justifyContent": "space-between"
  },
  "content-balance-payment-des": {
    "paddingLeft": "30",
    "paddingBottom": "30",
    "fontSize": "24",
    "color": "#999999"
  },
  "content-balance-payment-content": {
    "fontSize": "28",
    "color": "#666666",
    "lineHeight": "90",
    "height": "90"
  ...
  "senior-promotion-img": {
    "width": "750",
    "height": "100"
  },
  "content-balance-comment-title": {
    "height": "100",
    "fontSize": "28",
    "color": "#333333",
    "textAlign": "center",
...
var bottom = 0;
var promptModule = weex.requireModule('promptModule');
var event = new BroadcastChannel('wallet');
exports.default = {
    ...
    methods: {
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().user_finance, {}, function (res) {
                if (res.data.code == '0') {
                    _this.withdraw = parseFloat(res.data.data.can_withdraw_money).toFixed(2);
                    _this.balance = parseFloat(res.data.data.balance).toFixed(2);
                    _this.old_balance = parseFloat(res.data.data.old_balance).toFixed(2);
                    _this.bank = res.data.data.bank;
                    _this.has_aud = res.data.data.has_aud;
                    _this.level = res.data.data.level;
                    _this.withdraw_icon = res.data.data.withdraw_icon;
                    _this.recharge_icon = res.data.data.recharge_icon;
                    _this.aud_balance = parseFloat(res.data.data.aud_balance).toFixed(2);
                    _this.one_aud_to_rmb = parseFloat(res.data.data.one_aud_to_rmb).toFixed(2);
                    _this.aud_to_rmb_balance = parseFloat(res.data.data.aud_to_rmb_balance).toFixed(2);
                    _this.isBindNewCard();
        ...
        isBindNewCard: function isBindNewCard() {
            ...
            _this.Get(_this.api().bank_info, {}, function (res) {
                if (res.data.code == 0) {
                    _this.bind_new_bank = res.data.data.bind_new_bank;
                    _this.isHsaNewBank = !(res.data.data.bind_new_bank == 0 && _this.bank); //没有新卡且有老卡
                    _this.newBank = res.data.data.bank_info;
                } else promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
            });
        },
        clickDes: function clickDes() {
            this.jumpTo2('web/webView', '', { title: "充值说明", url: encodeURIComponent("https://wap.abmau.com/rechargeExplain") });
        },
        clickWDDetail: function clickWDDetail() {
            this.jumpTo2('personal/financeManager/forwardRecord', '', {});
        },
        clickBalanceDetail: function clickBalanceDetail() {
            this.jumpTo2('personal/financeManager/account', '', {});
        },
        clickWithDraw: function clickWithDraw() {
            this.jumpTo2('personal/withdraw/withdraw_bank', '', { mobile: this.mobile });
        },
        clickRecharge: function clickRecharge() {
            if (this.compareVersion(weex.config.env.appVersion, '3.3.0')) {
                this.jumpTo2('personal/recharge/rechargeAccount', '', {});
            } else {
                promptModule.showPrompt({ msg: '更新App最新版本，才能使用该功能哦！', type: 'prompt' });
            }
        },
        clickBank: function clickBank(bank) {
            if (this.bind_new_bank == 1) {
                this.jumpTo2('personal/finance/revampBankCard', '银行卡', { mobile: this.mobile, type: 'new_bank' });
            } else {
                if (!bank) this.jumpTo2('personal/finance/financeReason', '', { mobile: this.mobile, type: 'add_bank' });else this.jumpTo2('personal/bankCard/bankInfo', '银行卡', { type: 'bank_info', mobile: this.mobile, title: '银行卡' });
            }
        },

        //点击“立即充值”按钮，进入"升级充值"页面
        clickToSeniorPromotion: function clickToSeniorPromotion() {
            this.jumpTo2('personal/recharge/rechargeUpgradeLevel', '', {});
        },

        //添加银行卡理由
        clickReason: function clickReason() {
            this.jumpTo2('personal/finance/financeReason', '', { mobile: this.mobile, type: 'new_bank' });
        },
        clickBalance: function clickBalance() {
            var oldMoney = this.old_balance;
            var totalMoney = this.balance;
            if (oldMoney > 0) {
                var cash = '0.00';
                if (totalMoney > 0) {
                    cash = totalMoney - oldMoney;
                }
                this.jumpTo2('personal/financeManager/financeDetail', '', { old_balance: this.old_balance, balance: parseFloat(cash).toFixed(2) + "" });
            }
        }
    },
    created: function created() {
        var _this = this;
        _this.getTopHeight(this);
        _this.isIpx(_this);
        _this.mobile = _this.GetUrlPara(weex.config.bundleUrl, 'mobile');
        _this.fetch();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
  ...
  }, [_vm._v("为及时收到提现款项，我们强烈建议您使用新的绑卡方式绑定提现银行卡。")]), _c('text', {
    style: {
      textAlign: 'center',
      fontSize: 26 + 'px',
      width: 130 + 'px',
  ...
  }, [_vm._v("立即查看")])]) : _vm._e(), _c('div', {
    staticClass: ["content-balance"],
    on: {
      "click": function($event) {
        _vm.clickBalance()
      }
    ...
    staticClass: ["content-balance-money"]
  }, [_vm._v("¥" + _vm._s(_vm.balance))]), _c('text', {
    staticClass: ["content-balance-title"]
  }, [_vm._v("账户余额（元）")])]), _c('div', {
    staticClass: ["content-balance-comment", "bg_gray"]
  }, [_c('text', {
    staticClass: ["content-balance-comment-title"]
  }, [_vm._v("可提现余额(元)")]), _c('text', {
    staticClass: ["content-balance-comment-money"]
  }, [_vm._v("¥" + _vm._s(_vm.withdraw))])]), _c('div', {
    staticClass: ["content-balance-comment", "bg_white"],
    on: {
      "click": function($event) {
        _vm.clickWDDetail()
      }
    ...
    on: {
      "click": function($event) {
        _vm.clickBalanceDetail()
      }
    }
  }, [_c('text', {
    staticClass: ["content-balance-comment-title"]
  }, [_vm._v("账户余额明细")]), _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
    ...
    on: {
      "click": function($event) {
        _vm.clickBank(_vm.bank)
      }
    }
  }, [_c('text', {
    staticClass: ["content-balance-comment-title"]
  }, [_vm._v("添加银行卡")]), _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
  ...
  }), (_vm.has_aud == 0) ? _c('line') : _vm._e(), (_vm.level != 5) ? _c('div', {
    staticClass: ["senior-promotion"],
    on: {
      "click": function($event) {
        _vm.clickToSeniorPromotion()
      }
    }
  }, [_c('image', {
    staticClass: ["senior-promotion-img"],
    attrs: {
      "src": "http://img.abmau.com/abmau/5c8a6218168c187a2306f789f6e1850e.png"
    }
  })]) : _vm._e(), (_vm.has_aud == 1) ? _c('div', [_c('div', {
    staticClass: ["content-balance-payment"]
  }, [_c('div', {
    staticClass: ["content-balance-payment-h"]
  }, [_c('text', {
    staticClass: ["content-balance-money"]
  }, [_vm._v("$" + _vm._s(_vm.aud_balance))]), _c('text', {
    staticClass: ["content-balance-payment-des"],
    on: {
      "click": function($event) {
        _vm.clickDes()
      }
    }
  }, [_vm._v("澳币账户如何充值？")])]), _c('text', {
    staticClass: ["content-balance-title"]
  }, [_vm._v("澳币账户总金额(澳元)")])]), _c('line'), _c('div', {
    staticClass: ["content-balance-comment", "bg_white"]
  }, [_c('text', {
    staticClass: ["content-balance-comment-title"]
  }, [_vm._v("当前汇率")]), _c('text', {
    staticClass: ["content-balance-payment-content"]
  }, [_vm._v("1澳元≈" + _vm._s(_vm.one_aud_to_rmb) + "人民币元")])]), _c('line'), _c('div', {
    staticClass: ["content-balance-comment", "bg_white"]
  }, [_c('text', {
    staticClass: ["content-balance-comment-title"]
  }, [_vm._v("换算人民币金额(元)")]), _c('text', {
    staticClass: ["content-balance-payment-content"]
  }, [_vm._v("¥" + _vm._s(_vm.aud_to_rmb_balance))])]), _c('line'), _c('div', {
    staticStyle: {
      width: "750px",
      height: "150px",
      backgroundColor: "#fff"
    }
  })], 1) : _vm._e()], 1), (_vm.level == 5) ? _c('div', {
    staticClass: ["footer"]
  }, [_c('div', {
    ...
    staticClass: ["footer-image"],
    attrs: {
      "src": _vm.recharge_icon
    }
  }), _c('text', {
    staticClass: ["footer-text-right"]
  }, [_vm._v("充值")])])]) : _vm._e(), (_vm.level != 5) ? _c('div', {
    staticClass: ["footer"]
  }, [_c('div', {
    ...
    staticClass: ["footer-image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/c1cea3eb5985d40fb6a9fa8a35a8cb27.png"
    }
  }), _c('text', {
