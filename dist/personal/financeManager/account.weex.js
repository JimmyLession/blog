...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\personal\\financeManager\\account.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-5e2c79da"
...
var _empty = __webpack_require__(17);
...
var bottom = 0;
exports.default = {
    components: { titleBar: _titleBar2.default, refresher: _refresh2.default, line: _line2.default, empty: _empty2.default },
    data: function data() {
        return {
            title: '账户余额明细',
            limit: 20,
            ...
            height: height,
            loading: false, //加载中
            allLoadingFinish: false, //数据是否全部加载完成
            emptyIsShow: false,
            bgImgSrc: '',
            items: [],
            is_sub: 0 //是否为子账号信息 1是 0不是
        };
    },
    ...
    methods: {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().goods_payment_record, {
                offset: _this.offset,
                limit: _this.limit
            }, function (res) {
                if (res.data.code == '0') {
                    if (res.data.data._count == 0) {
                        _this.emptyIsShow = true;
                    } else {
                        _this.emptyIsShow = false;
                    }
                    if (res.data.data._count > _this.offset) {
                        _this.offset += 20;
                    ...
                    for (var i = 0; i < res.data.data.item.length; i++) {
                        _this.items.push(res.data.data.item[i]);
                    }
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title-bar', {
    ...
    return (_vm.items.length != 0) ? _c('cell', {
      key: index,
      ref: "index",
      refInFor: true,
      ...
      staticClass: ["list-item-font-des"]
    ...
    }, [_c('text', [_vm._v(_vm._s(item.money))])])]) : _vm._e()
  }), (_vm.emptyIsShow) ? _c('cell', {
    staticClass: ["parent"],
    style: {
      top: _vm.height + 'px',
      bottom: _vm.bottom + 'px'
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.loading && _vm.items.length > 14) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
