...
var _home_message = __webpack_require__(2);

var _home_message2 = _interopRequireDefault(_home_message);
...
_home_message2.default.el = '#root';
new Vue(_home_message2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_message.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-42ab21f7"
...
exports.default = {
    ...
    methods: {
        ...
        message_lv: function message_lv(item) {
            if (item) {
                this.jumpTo2('home/home_message_lv', '', { msg_type: item.type, msg_title: item.name });
            }
        },
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().message_center, {}, function (res) {
                if (res.data.code == 0) {
                    _this.messageList = res.data.data;
                    _this.top_msg = res.data.data.top;
                    _this.middle_msg = res.data.data.middle;
                    _this.bottom_msg = res.data.data.bottom;
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["top_list_item"]
  }, _vm._l((_vm.top_msg), function(item, index) {
    return _c('div', {
      key: index
    }, [(item.last_unread) ? _c('div', {
      ...
      staticClass: ["item_describe"]
    }, [_c('text', {
      staticClass: ["item_title"]
    }, [_vm._v(_vm._s(item.name))]), (item.unread > 0) ? _c('text', {
      staticClass: ["item_count"]
    }, [_vm._v(_vm._s(item.unread) + "条未读")]) : _vm._e(), _c('div', {
      style: {
        flex: 1
      }
    }), (item.last_unread) ? _c('text', {
      staticClass: ["item_date"]
    }, [_vm._v(_vm._s(item.last_unread.created_at))]) : _vm._e()]), (item.last_unread) ? _c('text', {
      staticClass: ["item_desc"]
    }, [_vm._v(_vm._s(item.last_unread.title))]) : _vm._e()])]) : _vm._e(), (!item.last_unread) ? _c('div', {
      staticClass: ["item_body"],
      on: {
        "click": function($event) {
          _vm.message_lv(item)
      ...
      staticClass: ["item_title"]
    }, [_vm._v(_vm._s(item.name))])])]) : _vm._e()]) : _vm._e(), (index != _vm.top_msg.length - 1) ? _c('line') : _vm._e()], 1)
  })), _c('div', {
    staticClass: ["middle_list_item"]
  }, _vm._l((_vm.middle_msg), function(item, index) {
    return _c('div', {
      key: index
    }, [(item.last_unread) ? _c('div', {
      staticClass: ["item_body"],
    ...
    staticClass: ["middle_list_item"]
  }, _vm._l((_vm.bottom_msg), function(item, index) {
    return _c('div', {
      key: index
    }, [(item.last_unread) ? _c('div', {
      staticClass: ["item_body"],
