...
var _homeYearFestival = __webpack_require__(2);

var _homeYearFestival2 = _interopRequireDefault(_homeYearFestival);
...
_homeYearFestival2.default.el = '#root';
new Vue(_homeYearFestival2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\homeYearFestival.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3194e624"
...
exports.default = {
    ...
    methods: {
        ...
        scrollToSection: function scrollToSection(index) {
            var ref = this.$refs.festival_item[index];
            if (!ref) return;
            var offset = this.isIphoneX ? -168 : -120;
            dom.scrollToElement(ref, { offset: offset });
        },
        ...
        jumpModule: function jumpModule(type, title, id) {
            ...
            switch (type) {
                ...
                case 6:
                    //母婴护理 二级页
                    _this.jumpTo2('home/yearFestivalDetail', '', { id: id });
                    break;
            }
        },
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().home_index_festival, {}, function (res) {
                if (res.data.code == '0') {
                    ...
                    _this.festival = res.data.data.festival;
                    _this.buybrand = res.data.data.buybrand;
                    _this.opinionHasNew(_this.navigator.time);
                    _this.festival_title = [];
                    for (var i = 0; i < _this.festival.length; i++) {
                        _this.festival_title.push(_this.festival[i].name);
                    }
    ...
    created: function created() {
        ...
        if (weex.config.env.platform.toLowerCase() === 'ios') _this.isTop = 0;else {
            _this.isTop = -1;
            _this.sliderStyle = { flex: 1, width: '750px' };
        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["indicator"]
  }) : _vm._e()], 2) : _vm._e(), (_vm.isIphoneX) ? _c('div', {
    staticClass: ["banner_bottom"],
    style: {
      top: (750 / (_vm.banner.width / _vm.banner.height) + 48 - 51 - 94) + 'px'
    },
    on: {
      "click": function($event) {
        _vm.jumpToBanner('CEO Livia的选品哲学', _vm.banner.add_url)
      }
    }
  }) : _vm._e(), (!_vm.isIphoneX) ? _c('div', {
    staticClass: ["banner_bottom"],
    style: {
      top: 750 / (_vm.banner.width / _vm.banner.height) - 51 - 94 + 'px'
    },
    on: {
      "click": function($event) {
        _vm.jumpToBanner('CEO Livia的选品哲学', _vm.banner.add_url)
  ...
  }) : _vm._e(), (_vm.show_titlebar) ? _c('div', {
  ...
  }, [_vm._m(0), _vm._m(1), _vm._m(2), _c('image', {
    staticClass: ["right_arrows_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/4a5f2283850d1a0dc703f9bfcbf29581.png"
    }
  })]), (_vm.banner_notice && _vm.banner_notice != null) ? _c('div', {
  ...
  }) : _vm._e()])])]), (_vm.discount_banner && _vm.discount_banner.image_url != '') ? _c('div', {
  ...
  })]), (_vm.recommend.data.length != 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  })], 2) : _vm._e()]) : _vm._e(), (_vm.festival_title && _vm.festival_title.length != 0) ? _c('cell', {
    staticClass: ["line_space"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  }) : _vm._e(), (_vm.festival_title.length != 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  }, _vm._l((_vm.festival_title), function(item, index) {
    return _c('div', {
      staticClass: ["item_content"]
    }, [_c('text', {
      staticClass: ["item_content_text"],
      style: {
        width: index > 1 ? '224px' : '343px'
      },
      on: {
        "click": function($event) {
          _vm.scrollToSection(index)
        }
      }
    }, [_vm._v(_vm._s(item) + " >")])])
  }))]) : _vm._e(), (_vm.festival && _vm.festival.length != 0) ? _c('cell', {
    staticClass: ["line_space"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  }) : _vm._e(), _vm._l((_vm.festival), function(data) {
    return (_vm.festival.length != 0) ? _c('cell', {
      ref: "festival_item",
      refInFor: true,
      staticClass: ["recommend"],
      appendAsTree: true,
      ...
      on: {
        "click": function($event) {
          _vm.jumpModule(4, data.name, data.id)
        }
      }
    }, [_c('text', {
      staticClass: ["module_title_text"]
    }, [_vm._v(_vm._s(data.name))]), _c('image', {
      staticClass: ["module_title_image"],
      attrs: {
        "src": "assets://home_title_more"
      }
      ...
      on: {
        "click": function($event) {
          _vm.startWeb(data.name, data.url, data.sharelink, data.shareimg, data.sharetitle, data.sharedesc)
        }
      }
    }, [_c('image', {
      staticClass: ["top_banner"],
    ...
    })]) : _vm._e(), _vm._l((data.data), function(item, index) {
      return _c('div', {
        staticClass: ["recommend_cell"]
      }, [_c('div', {
        staticClass: ["recommend_item"],
        ...
        staticClass: ["retail"]
      }, [_vm._v(")")]) : _vm._e()])])])]), (index != (data.data.length - 1)) ? _c('div', {
        staticClass: ["line-item"]
      }) : _vm._e()])
    }), _c('div', {
      staticStyle: {
  ...
  }) : _vm._e()], 2)], 1) : _vm._e()]), (_vm.starproduct.data.length != 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  }))]) : _vm._e()]), (_vm.buybrand && _vm.buybrand.data.length != 0) ? _c('cell', {
    staticClass: ["line_space"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
  ...
  return _c('div', {
    ...
    attrs: {
      "src": "http://img.abmau.com/abmau/570f3771cad19dbec02f0862f1f15d58.png"
    }
  }), _c('text', {
  ...
  return _c('div', {
    ...
    staticClass: ["left_content_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/b26c3037a5e8adeee935f78c2cb87b12.png"
    }
  }), _c('text', {
    staticClass: ["right_content_title"]
  }, [_vm._v("独家授权")])])
  ...
  return _c('div', {
    ...
    staticClass: ["left_content_image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/8691a2a95259b82ee7bf96d19dfc0d3d.png"
    }
  }), _c('text', {
    staticClass: ["right_content_title"]
  }, [_vm._v("正品保证")])])
