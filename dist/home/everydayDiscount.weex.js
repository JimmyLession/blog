...
var _everydayDiscount = __webpack_require__(2);

var _everydayDiscount2 = _interopRequireDefault(_everydayDiscount);
...
_everydayDiscount2.default.el = '#root';
new Vue(_everydayDiscount2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\everydayDiscount.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-290372d2"
...
exports.default = {
    components: { title: _titleBar2.default, refresher: _refresh2.default, item: _commodityList2.default, line: _line2.default, pop: _buyGoodsPop2.default, empty: _empty2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
    ...
    methods: {
        ...
        fetch: function fetch() {
            ...
            var _this = this;
            _this.Get(_this.api().order_center, {
                limit: _this.limit,
                offset: _this.offset,
                keyword: "胶原蛋白",
                is_store: 0,
                ...
                loadingModule.cancel(function (ret) {
                    ...
                    if (result == "dismiss") {
                        if (res.data.code == 0) {
                            ...
                            _this.getShopFee(_this.goodsSku.id, _this.num);
        ...
        selectDepot: function selectDepot(data, type, input) {
            ...
            this.tax_region_id = "";
            //   this.resetRegions(this.goods.all_region);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
  ...
  }, [_vm._m(0), _vm._l((_vm.data), function(items, index) {
    return _c('cell', {
      key: index,
      staticClass: ["item"],
      appendAsTree: true,
    ...
    }), (_vm.item.in_cart == 0 || _vm.item.online_status == 0) ? _c('line') : _vm._e(), (_vm.item.in_cart == 0 || _vm.item.online_status == 0) ? _c('div', {
      staticClass: ["list_bottom", "row"]
    }, [(items.in_cart == 0) ? _c('div', {
      staticClass: ["list_bottom_item", "row"],
      on: {
        "click": function($event) {
          _vm.addCart(items.id)
        }
      }
    }, [_vm._m(1, true), _c('text', {
      staticClass: ["list_bottom_item_text"]
    }, [_vm._v("加入购物车")])]) : _vm._e(), _c('div', {
      staticClass: ["list_bottom_item", "row"],
      on: {
        "click": function($event) {
          _vm.buyNow(items.id)
      ...
      staticClass: ["list_bottom_item_text"]
    }, [_vm._v("立即购买")])])]) : _vm._e()], 1)
  }), (_vm.isloading && _vm.data.length >= 2) ? _c('cell', {
    ...
    staticClass: ["loading-over-txt"]
  }, [_vm._v("已经全部加载完毕")]) : _vm._e()]) : _vm._e()], 2), (_vm.showAddCart) ? _c('pop', {
    staticClass: ["pop"],
    attrs: {
  ...
  return _c('cell', {
    ...
    attrs: {
      "src": "http://img.abmau.com/abmau/20bd6c8464018c00513c3288d5946a25.jpg"
    }
  })])])
