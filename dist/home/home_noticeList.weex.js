...
var _home_noticeList = __webpack_require__(2);

var _home_noticeList2 = _interopRequireDefault(_home_noticeList);
...
_home_noticeList2.default.el = '#root';
new Vue(_home_noticeList2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_noticeList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-797cad56"
...
var promptModule = weex.requireModule('promptModule');
exports.default = {
    components: { title: _titleBar2.default, refresher: _refresh2.default, line: _line2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
            ...
            size: 20,
            loading: false,
            allLoadingFinsh: false, //是否数据全部加载  false:还没有全部加载  true:已经全部加载了
            noticeList: {}
        };
    },
    ...
    methods: {
        onloading: function onloading() {
            ...
            this.page++;
            this.requestToGetNoticeList();
        },
        clickDetail: function clickDetail(url) {
            this.jumpTo2('web/webView', '', { url: encodeURIComponent(url), title: '单创通知' });
        },
        ...
        //进行公告列表请求
        requestToGetNoticeList: function requestToGetNoticeList() {
            var _this = this;
            _this.Get(_this.api().home_notice, {
                size: _this.size,
                page: _this.page
            }, function (res) {
                //请求成功
                if (res.data.code == '0') {
                    ...
                    if (_this.page == 1) {
                        ...
                        for (var arr in res.data.data) {
                            _this.noticeList.push(res.data.data[arr]);
                        }
                    }
                } else {
                    //请求失败
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    return _c('cell', {
      ...
      staticClass: ["item_date_content"]
    }, [_vm._v(_vm._s(item.created_at))])]), _c('div', {
      staticClass: ["notice"]
    }, [_c('text', {
      staticClass: ["notice_tittle"]
    }, [_vm._v(_vm._s(item.title))]), (item.url != '') ? _c('div', {
      staticClass: ["line"]
    }) : _vm._e(), (item.url != '') ? _c('text', {
      staticClass: ["notice_content", "lines"]
    }, [_vm._v(_vm._s(item.content))]) : _vm._e(), (item.url == '') ? _c('text', {
      staticClass: ["notice_content"]
    }, [_vm._v(_vm._s(item.content))]) : _vm._e(), (item.url != '') ? _c('div', {
      staticClass: ["line"]
    }) : _vm._e(), (item.url != '') ? _c('div', {
      staticClass: ["notice_detail"],
      on: {
        "click": function($event) {
          _vm.clickDetail(item.url)
        }
      }
    }, [_c('text', {
      staticClass: ["notice_detail_text"]
  ...
  }), (_vm.loading && _vm.noticeList.length > 18) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
