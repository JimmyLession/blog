...
var _superWelfare = __webpack_require__(3);

var _superWelfare2 = _interopRequireDefault(_superWelfare);
...
_superWelfare2.default.el = '#root';
new Vue(_superWelfare2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\superWelfare.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-39ac6ce1"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().doubleTag, {
                id: _this.id
            }, function (res) {
                if (res.data.code == "0") {
                    _this.title = res.data.data.subject_title;
                    _this.banner_img_url = res.data.data.banner_img_url;
                    _this.banner_url = res.data.data.banner_url;
                    _this.banner_img_id = res.data.data.banner_img_id;
                    _this.sharedesc = res.data.data.sharedesc;
                    _this.shareimg = res.data.data.shareimg;
                    _this.shareimgid = res.data.data.shareimgid;
                    _this.sharelink = res.data.data.sharelink;
                    _this.sharetitle = res.data.data.sharetitle;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    on: {
      "click": function($event) {
        _vm.startWeb('', _vm.banner_url, _vm.sharelink, _vm.shareimg, _vm.sharetitle, _vm.sharedesc)
      }
    }
  }, [_c('image', {
  ...
  })])]) : _vm._e(), _vm._l((_vm.data), function(items, index) {
    return _c('cell', {
      key: index,
      appendAsTree: true,
      attrs: {
    ...
    }, [(items.item_goods_tag != '') ? _c('div', {
      staticClass: ["time-title"]
    }, [_c('text', {
      staticClass: ["time-title-text"]
    }, [_vm._v(_vm._s(items.item_goods_tag))])]) : _vm._e(), _vm._l((items.item_data), function(item, index) {
      return _c('div', {
        key: index,
        staticClass: ["item"]
      }, [_c('item', {
