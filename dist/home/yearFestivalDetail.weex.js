...
var _yearFestivalDetail = __webpack_require__(3);

var _yearFestivalDetail2 = _interopRequireDefault(_yearFestivalDetail);
...
_yearFestivalDetail2.default.el = '#root';
new Vue(_yearFestivalDetail2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\yearFestivalDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-531e2d56"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
        ...
        playVideo: function playVideo(video_url) {
            if (video_url.length == 0) return;
            if (utilModule.showVideo) {
                utilModule.showVideo(video_url, null);
            }
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    return _c('cell', {
      ...
      style: {
        height: items.brand_img_height != 0 ? 750 / (items.brand_img_width / items.brand_img_height) : 380
      },
      attrs: {
        "src": items.brand_img_url
      }
    }), (items.brand_video_image != null && items.brand_video_image.length > 0) ? _c('image', {
      staticClass: ["video_bg"],
      attrs: {
        "src": items.brand_video_image
      },
      on: {
        "click": function($event) {
          _vm.playVideo(items.brand_video_url)
        }
      }
    }) : _vm._e(), (items.brand_video_image != null && items.brand_video_image.length > 0) ? _c('image', {
      staticClass: ["video_default"],
      attrs: {
        "src": "assets://jc_play_normal"
      },
      on: {
        "click": function($event) {
          _vm.playVideo(items.brand_video_url)
      ...
      staticClass: ["top_bg"],
      style: {
        top: items.brand_img_height != 0 ? 750 / (items.brand_img_width / items.brand_img_height) - 80 : 300
      },
      on: {
        "click": function($event) {
