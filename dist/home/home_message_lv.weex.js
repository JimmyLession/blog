...
var _home_message_lv = __webpack_require__(2);

var _home_message_lv2 = _interopRequireDefault(_home_message_lv);
...
_home_message_lv2.default.el = '#root';
new Vue(_home_message_lv2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_message_lv.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-57dd4882"
...
var bottom = 0;
var promptModule = weex.requireModule('promptModule');
var message = new BroadcastChannel('event');
...
exports.default = {
    ...
    methods: {
        ...
        //消息查看详情
        checkMessageDetail: function checkMessageDetail(item) {
            var url = item.jump_url;
            this.jumpToBanner(item.title, url, '', '', '', '');
        },
        requestMessageList: function requestMessageList() {
            var _this = this;
            _this.Get(_this.api().message_check_detail, {
                type: _this.msg_type,
                limit: _this.limit,
                offset: _this.offset
            }, function (res) {
                if (res.data.code == '0') {
                    message.postMessage(_this.eventBusTag().REFRESH_MESSAGE);
                    if (res.data.count == 0) _this.empty = true;else _this.empty = false;
    ...
    created: function created() {
        ...
        _this.isIpx(_this);
        _this.msg_type = _this.GetUrlPara(weex.config.bundleUrl, 'msg_type');
        _this.msg_title = _this.GetUrlPara(weex.config.bundleUrl, 'msg_title');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._l((_vm.data), function(megItem) {
    return (_vm.data.length > 0) ? _c('cell', {
      ...
      staticClass: ["row", "date_show_top"]
    }, [_c('image', {
      staticClass: ["item_date_img"],
      attrs: {
        "src": "http://img.abmau.com/abmau/1fc342c1752db6331e707d425f63055e.png"
      }
    }), _c('text', {
      staticClass: ["item_date"]
    }, [_vm._v(_vm._s(megItem.created_at))])]), _c('div', {
      staticClass: ["item_content"]
    }, [(megItem.is_jump == 0 && (megItem.title_img == null || megItem.title_img == '')) ? _c('div', {
      staticClass: ["item_content_part"]
    }, [_c('div', {
      staticClass: ["item_head"]
    }, [(megItem.is_read == 0) ? _c('text', {
      staticClass: ["is_new"]
    }) : _vm._e(), _c('text', {
      staticClass: ["item_title"]
    }, [_vm._v(_vm._s(megItem.title))])]), _c('text', {
      staticClass: ["item_des"]
    }, [_vm._v(_vm._s(megItem.content))])]) : _vm._e(), (megItem.is_jump == 1 && (megItem.title_img == null || megItem.title_img == '')) ? _c('div', {
      staticClass: ["item_content_part"],
      on: {
        "click": function($event) {
          _vm.checkMessageDetail(megItem)
        }
      }
    }, [_c('div', {
      staticClass: ["item_head"]
      ...
      staticClass: ["item_detail_title"]
    }, [_vm._v(_vm._s(megItem.title))])]), _c('text', {
      staticClass: ["item_detail_des"]
    }, [_vm._v(_vm._s(megItem.content))]), _vm._m(0, true)]) : _vm._e(), (megItem.title_img != '' && megItem.title_img != null) ? _c('div', {
      staticClass: ["item_content_part"],
      on: {
        "click": function($event) {
          _vm.checkMessageDetail(megItem)
      ...
      staticClass: ["item_pic_title"]
    }, [_vm._v(_vm._s(megItem.title))])]), _c('image', {
      staticClass: ["item_pic_img"],
      attrs: {
        "src": megItem.title_img
      }
    }), _c('text', {
      staticClass: ["item_pic_des"]
    }, [_vm._v(_vm._s(megItem.content))]), (megItem.is_jump == 1) ? _c('div', {
      staticClass: ["item_detail_check"]
    }, [_c('text', {
      staticClass: ["check_detail_title"]
    }, [_vm._v("立即前往")]), _c('image', {
      staticClass: ["check_detail_img"],
      attrs: {
        "src": "http://img.abmau.com/abmau/226affc94f2938b2f49f1f94ca5f63d0.png"
      }
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.isLoading && _vm.data.length > 17) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
