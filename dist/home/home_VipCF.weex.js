...
var _home_VipCF = __webpack_require__(2);

var _home_VipCF2 = _interopRequireDefault(_home_VipCF);
...
_home_VipCF2.default.el = '#root';
new Vue(_home_VipCF2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_VipCF.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-cef7dee0"
...
exports.default = {
    ...
    methods: {
        loadingDown: function loadingDown() {
            ...
            this.page = 1;
            this.allLoadingFinish = false, this.fetch();
        },
        onloading: function onloading() {
            if (!this.loading && this.gift.data.length < this.size) return;
            this.page++;
            this.fetch();
        },
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().home_gift, {
                page: _this.page,
                size: _this.size
            }, function (res) {
                if (res.data.code == '0') {
                    _this.gift.title = res.data.data.gift.title;
                    if (_this.page == 1) {
                        _this.gift.data = res.data.data.gift.data;
                    } else {
                        for (var arr in res.data.data.gift.data) {
                            _this.gift.data.push(res.data.data.gift.data[arr]);
                        }
                    }
                    if (res.data.data.gift.data.length == _this.size) {
                        _this.loading = true;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }))]) : _vm._e()]), (_vm.loading && _vm.gift.data.length > 18) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
