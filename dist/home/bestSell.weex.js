...
var _bestSell = __webpack_require__(2);

var _bestSell2 = _interopRequireDefault(_bestSell);
...
_bestSell2.default.el = '#root';
new Vue(_bestSell2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\bestSell.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-380b8926"
...
var _commodityList = __webpack_require__(13);

var _commodityList2 = _interopRequireDefault(_commodityList);

var _newBuyGoodsPop = __webpack_require__(17);
...
exports.default = {
    components: { title: _titleBar2.default, refresher: _refresh2.default, item: _commodityList2.default, pop: _newBuyGoodsPop2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
    ...
    methods: {
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().newRecommend, {}, function (res) {
                if (res.data.code == "0") {
                    _this.title = res.data.data.recommend.title;
                    _this.url = res.data.data.recommend.url;
                    _this.shareUrl = res.data.data.recommend.sharelink;
                    _this.shareImg = res.data.data.recommend.shareimg;
                    _this.shareTitle = res.data.data.recommend.sharetitle;
                    _this.shareDes = res.data.data.recommend.sharedesc;
                    _this.banner_img_url = res.data.data.recommend.banner_img_url;
                    var count = res.data.data.recommend.data.length - 1;
                    var item = res.data.data.recommend.data;
                    _this.firstItem = item[0];
                    for (var i = 1; i < count; i++) {
                        item[i]['index'] = (i + 1).toString();
                        _this.data.push(item[i]);
                    }
                    _this.lastItem = item[count];
                    _this.firstItem['index'] = '1';
                    _this.lastItem['index'] = (count + 1).toString();
                } else {
    ...
    created: function created() {
        var _this = this;
        this.strTitle = this.GetUrlPara(weex.config.bundleUrl, 'title');
...
var _gridSelect = __webpack_require__(20);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    on: {
      "click": function($event) {
        _vm.startWeb(_vm.title, _vm.url, _vm.shareUrl, _vm.shareImg, _vm.shareTitle, _vm.shareDes)
      }
    }
  }, [_c('image', {
    staticClass: ["banner-img"],
    attrs: {
      "src": _vm.banner_img_url
    }
  })]), (_vm.firstItem && _vm.firstItem.in_cart != 0 && _vm.firstItem.online_status != 0) ? _c('image', {
    staticClass: ["first-bgImg"],
    attrs: {
      "src": "http://img.abmau.com/abmau/f36e3fc3a8cf91969031a7ef48431282.png"
    }
  }) : _vm._e(), (_vm.firstItem && (_vm.firstItem.in_cart == 0 || _vm.firstItem.online_status == 0)) ? _c('image', {
    staticClass: ["first-bgImg-canbuy"],
    attrs: {
      "src": "http://img.abmau.com/abmau/71342c6a975460dcbe07a942e9444d38.png"
    }
  }) : _vm._e(), (_vm.firstItem) ? _c('div', {
    staticClass: ["first-parent"]
  }, [_c('item', {
    attrs: {
      "goodsList": _vm.firstItem,
      "width": "388",
      "widthRetail": "318",
      "isShowTop": true
    }
  }), (_vm.firstItem.in_cart == 0 || _vm.firstItem.online_status == 0) ? _c('div', {
    staticClass: ["line"]
  }) : _vm._e(), (_vm.firstItem.in_cart == 0 || _vm.firstItem.online_status == 0) ? _c('div', {
    staticClass: ["list_bottom", "row"]
  }, [(_vm.firstItem.in_cart == 0) ? _c('div', {
    staticClass: ["list_bottom_item", "row"],
    on: {
      "click": function($event) {
        _vm.addCart(_vm.firstItem.id)
      }
    }
  }, [_vm._m(0), _c('text', {
    staticClass: ["list_bottom_item_text"]
  }, [_vm._v("加入购物车")])]) : _vm._e(), (_vm.firstItem.online_status == 0) ? _c('div', {
    staticClass: ["list_bottom_item", "row"],
    on: {
      "click": function($event) {
        _vm.buyNow(_vm.firstItem.id)
      }
    }
  }, [_vm._m(1), _c('text', {
    staticClass: ["list_bottom_item_text"]
  }, [_vm._v("立即购买")])]) : _vm._e()]) : _vm._e()], 1) : _vm._e()]), _vm._l((_vm.data), function(item, index) {
    return _c('cell', {
      key: index,
      staticClass: ["item-brand", "center-item"],
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
    }, [(item.in_cart != 0 && item.online_status != 0) ? _c('image', {
      staticClass: ["center-bgImg"],
      attrs: {
        "src": "http://img.abmau.com/abmau/b30e180fd1334794b9f04f13116585a4.png"
      }
    }) : _vm._e(), (item.in_cart == 0 || item.online_status == 0) ? _c('image', {
      staticClass: ["center-bgImg-canbuy"],
      attrs: {
        "src": "http://img.abmau.com/abmau/f3c33ef0724f4720b7809a4aa207016f.png"
      }
    }) : _vm._e(), _c('div', {
    ...
    }), (item.in_cart == 0 || item.online_status == 0) ? _c('div', {
      staticClass: ["line"]
    }) : _vm._e(), (item.in_cart == 0 || item.online_status == 0) ? _c('div', {
      staticClass: ["list_bottom", "row"]
    ...
    }, [_vm._m(3, true), _c('text', {
      staticClass: ["list_bottom_item_text"]
    }, [_vm._v("立即购买")])]) : _vm._e()]) : _vm._e()], 1)])
  }), _c('cell', {
    staticClass: ["item-brand", "last-item"],
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  }, [(_vm.lastItem && _vm.lastItem.in_cart != 0 && _vm.lastItem.online_status != 0) ? _c('image', {
    staticClass: ["last-bgImg"],
    attrs: {
      "src": "http://img.abmau.com/abmau/0b3cbcb65edfb040079074d88470777a.png"
    }
  }) : _vm._e(), (_vm.lastItem && (_vm.lastItem.in_cart == 0 || _vm.lastItem.online_status == 0)) ? _c('image', {
    staticClass: ["last-bgImg-canbuy"],
    attrs: {
      "src": "http://img.abmau.com/abmau/087247f60f98116d5e51d907eacd358c.png"
    }
  }) : _vm._e(), (_vm.lastItem) ? _c('div', {
    staticClass: ["last-parent"]
  }, [_c('item', {
    attrs: {
      "goodsList": _vm.lastItem,
      "width": "388",
      "widthRetail": "318",
      "isShowTop": true
    }
  }), (_vm.lastItem.in_cart == 0 || _vm.lastItem.online_status == 0) ? _c('div', {
    staticClass: ["line"]
  }) : _vm._e(), (_vm.lastItem.in_cart == 0 || _vm.lastItem.online_status == 0) ? _c('div', {
    staticClass: ["list_bottom", "row"],
    style: {
      borderBottomLeftRadius: '8px',
      borderBottomRightRadius: '8px'
    }
  }, [(_vm.lastItem.in_cart == 0) ? _c('div', {
    staticClass: ["list_bottom_item", "row"],
    on: {
      "click": function($event) {
        _vm.addCart(_vm.lastItem.id)
      }
    }
  }, [_vm._m(4), _c('text', {
    staticClass: ["list_bottom_item_text"]
  }, [_vm._v("加入购物车")])]) : _vm._e(), (_vm.lastItem.online_status == 0) ? _c('div', {
    staticClass: ["list_bottom_item", "row"],
    on: {
      "click": function($event) {
        _vm.buyNow(_vm.lastItem.id)
      }
    }
  }, [_vm._m(5), _c('text', {
    staticClass: ["list_bottom_item_text"]
  }, [_vm._v("立即购买")])]) : _vm._e()]) : _vm._e()], 1) : _vm._e()])], 2), (_vm.showAddCart) ? _c('pop', {
    staticClass: ["pop"],
    attrs: {
      "fee": _vm.fee,
      "goods": _vm.goodsSku,
