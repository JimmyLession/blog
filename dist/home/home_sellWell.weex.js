...
var _home_sellWell = __webpack_require__(2);

var _home_sellWell2 = _interopRequireDefault(_home_sellWell);
...
_home_sellWell2.default.el = '#root';
new Vue(_home_sellWell2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_sellWell.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-1ba48e00"
...
exports.default = {
    ...
    methods: {
        ...
        onloading: function onloading() {
            if (this.recommend.data.length < this.size) return;
            this.page++;
            this.fetch();
        },
        ...
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().recommend, {
                page: _this.page,
                size: _this.size
            }, function (res) {
                if (res.data.code == '0') {
                    _this.recommend.title = res.data.data.recommend.title;
                    if (res.data.data.recommend.data.length == _this.size) {
                        _this.loading = true;
                    ...
                    if (_this.page == 1) {
                        _this.recommend.data = res.data.data.recommend.data;
                    } else {
                        for (var arr in res.data.data.recommend.data) {
                            _this.recommend.data.push(res.data.data.recommend.data[arr]);
                        }
                    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }))]) : _vm._e(), (_vm.loading && _vm.recommend.data.length > 18) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
