...
var _home_brandtrace = __webpack_require__(2);

var _home_brandtrace2 = _interopRequireDefault(_home_brandtrace);
...
_home_brandtrace2.default.el = '#root';
new Vue(_home_brandtrace2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\home\\home_brandtrace.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-514e5bde"
...
exports.default = {
    ...
    methods: {
        onloading: function onloading() {
            if (this.brandtraceList.data.length < this.size) return;
            this.page++;
            this.requestList();
        },
        loadingDown: function loadingDown() {
            this.$refs.list.resetLoadmore();
            this.brandtraceList.data = [];
            this.page = 1;
            this.allLoadingFinish = false;
            this.requestList();
        },
        startWeb: function startWeb(title, item) {
            ...
            titleBar.startWeb({
                ...
                shareDes: item.sharecontent
            });
        },
        requestList: function requestList() {
            var _this = this;
            _this.Get(_this.api().brandtrace, {
                page: _this.page,
                size: _this.size
            }, function (res) {
                if (res.data.code == '0') {
                    _this.brandtraceList.title = res.data.data.brandtrace.title;
                    if (res.data.data.brandtrace.data.length == _this.size) {
                        _this.loading = true;
                    ...
                    for (var arr in res.data.data.brandtrace.data) {
                        _this.brandtraceList.data.push(res.data.data.brandtrace.data[arr]);
                    }
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    attrs: {
      "title": _vm.brandtraceList.title
    }
  }), _c('list', {
    ref: "list",
    staticClass: ["parent"],
  ...
  }, [_vm._l((_vm.brandtraceList.data), function(item, index) {
    return (_vm.brandtraceList.data.length > 0) ? _c('cell', {
      key: index,
      ...
      on: {
        "click": function($event) {
          _vm.startWeb(_vm.brandtraceList.title, item)
        }
      }
    }, [_c('image', {
    ...
    }, [_vm._v(_vm._s(item.sub_title))])]) : _vm._e()
  }), _c('refresher', {
    on: {
      "loadingDown": _vm.loadingDown
    }
  }), (_vm.loading && _vm.brandtraceList.data.length > 18) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
