...
_core2.default.el = '#root';
new Vue(_core2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\tryout\\core.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-16fc09db"
...
var _refresh = __webpack_require__(10);

var _refresh2 = _interopRequireDefault(_refresh);

var _empty = __webpack_require__(14);
...
var _applyTryRules = __webpack_require__(22);

var _applyTryRules2 = _interopRequireDefault(_applyTryRules);

var _orderMsg = __webpack_require__(40);

var _orderMsg2 = _interopRequireDefault(_orderMsg);
...
var bottom = 0;
exports.default = {
  components: { line: _line2.default, refresher: _refresh2.default, empty: _empty2.default, title: _titleBar2.default, apply: _applyTryRules2.default, order: _orderMsg2.default },
  filters: {
    time: function time(value) {
      var time = "";
      var day = parseInt(value / (60 * 60 * 24));
      var hour = parseInt(value % (60 * 60 * 24) / (60 * 60));
      var minute = parseInt(value % (60 * 60) / 60);
      var second = value % 60;
      time += day + "天 ";
      if (hour == 0) {
        time += "00";
  ...
  methods: {
    ...
    //跳转撰写报告
    click_report: function click_report(i, ri) {
      ...
      this.jumpTo2("tryout/tryoutReport", "", { id: i, rid: ri });
    },
        ...
        if (res.data.code == "0") {
          ...
          if (type == 1) {
            res.data.data.forEach(function (element) {
              if (element.status == 2) {
                _this.dataPast.push(element);
              } else {
                _this.data.push(element);
                if (element.level_time > 0) {
                  _this.countDown(element.level_time, function (t) {
                    element.level_time = t;
                  }, function () {
                    element.status = 3;
                    element.pstatus = 3;
                  });
          ...
          if (res.data.count > _this2.offset) {
    ...
    //跳转商品详情
    click_detail: function click_detail(i, s) {
      this.jumpTo2("tryout/tryDetail", "", { id: i, status: s });
    },

    //立即申请
    applyTry: function applyTry(i, gi) {
      var _this3 = this;

      this.Post(this.api().activity_apply_judge, {
        id: i
      }, function (res) {
        if (res.data.code == "0") {
          //点击申请试用
    ...
    applySure: function applySure(val) {
      ...
      if (val) {
        //点击確定，关闭申请试用
        this.mask = false;
        this.Post(this.api().buy_now, {
          trial_activity_id: this.id,
          ...
          if (res.data.code == "0") {
            _this4.jumpTo2('order/confirmOrder', '', { type: 'quick', address_id: '' });
          } else {
            promptModule.showPrompt({ msg: res.data.msg, type: "err" });
          }
        });
    ...
    // 关闭预约框
    closeOrderMask: function closeOrderMask(val) {
    ...
    //小红点验证
    redShowFun: function redShowFun() {
      var _this5 = this;

      this.Get(this.api().activity_littlered, {}, function (res) {
        if (res.data.code == "0") {
          if (res.data.data.status == 1) {
            _this5.redShow = true;
          } else if (res.data.data.status == 2) {
            _this5.redShow = false;
          }
        } else {
          promptModule.showPrompt({ msg: res.data.msg, type: "err" });
        }
  ...
  created: function created() {
    ...
    _this.getData(1);
    _this.redShowFun();
    tryoutdetail.onmessage = function (event) {
      if (!event.data) {
        return;
      }
      switch (event.data) {
        case _this.eventBusTag().REFRESH_CORE:
          _this.loadingDown();
          _this.redShowFun();
          break;
      }
...
var _wxcCheckbox = __webpack_require__(0);
...
var _urlParse = __webpack_require__(33);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\components\\orderMsg.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-433771e4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    created: function created() {
        var self = this;self.iPhoneX(self);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.click_detail(item.id, item.status)
        }
      }
    }, [_c('div', {
    ...
    }), (item.level_time > 0) ? _c('text', {
      staticClass: ["item_bottom_text"]
    }, [_vm._v("距开始 " + _vm._s(_vm._f("time")(item.level_time)))]) : _vm._e()]), _c('div', {
      staticClass: ["item_right"]
    }, [_c('text', {
      staticClass: ["item_right_text"]
    }, [_vm._v(_vm._s(item.name))]), _c('text', {
      staticClass: ["item_right_price"]
    }, [_vm._v("¥" + _vm._s(item.price))]), _c('text', {
      staticClass: ["item_right_num"]
    }, [_vm._v("限量" + _vm._s(item.num))]), _c('div', {
      staticClass: ["item_right_bottom"]
    }, [(item.pstatus == 1) ? _c('text', {
      staticClass: ["item_right_bottom_text", "apply"]
    }, [_vm._v("我要预约")]) : _vm._e(), (item.pstatus == 2) ? _c('text', {
      staticClass: ["item_right_bottom_text", "order"]
    }, [_vm._v("已预约")]) : _vm._e(), (item.pstatus == 3) ? _c('text', {
      staticClass: ["item_right_bottom_text", "apply"]
    }, [_vm._v("立即申请")]) : _vm._e(), (item.pstatus == 4) ? _c('text', {
      staticClass: ["item_right_bottom_text", "order"]
    }, [_vm._v("已申请")]) : _vm._e(), (item.pstatus == 5) ? _c('text', {
      staticClass: ["item_right_bottom_text", "order"]
    }, [_vm._v("申请结束")]) : _vm._e(), (item.status == 1) ? _c('text', {
      staticClass: ["item_right_bottom_text_people"]
    }, [_vm._v(_vm._s(item.follow_num) + "人关注")]) : _vm._e()])])]), _c('line')], 1)
  }), (_vm.dataPast.length > 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["interval_title"]
  }, [_vm._v("往期试用")])]) : _vm._e(), _vm._l((_vm.dataPast), function(item, i) {
    return _c('cell', {
      key: i,
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["item_bottom_text"]
    }, [_vm._v("距离开始剩余" + _vm._s(_vm._f("time")(item.level_time)))]) : _vm._e()]), _c('div', {
      staticClass: ["item_right"]
    }, [_c('text', {
      staticClass: ["item_right_text"]
    }, [_vm._v(_vm._s(item.name))]), _c('text', {
      ...
      staticClass: ["item_right_bottom"]
    }, [(item.status == 2) ? _c('text', {
      staticClass: ["item_right_bottom_text", "see"]
    }, [_vm._v("查看报告")]) : _vm._e()])])])])
  ...
  }, [_c('empty')], 1) : _vm._e(), (false) ? _c('cell', {
    ...
    staticClass: ["loading-over-txt"]
  }, [_vm._v("已经全部加载完毕")]) : _vm._e()]) : _vm._e()], 2), (_vm.mask) ? _c('apply', {
    on: {
      "close": _vm.closeMask,
      "applySure": _vm.applySure
    }
  }) : _vm._e(), (_vm.orderMask) ? _c('order', {
    on: {
      "close": _vm.closeOrderMask
    }
  }) : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
