...
var _seeTryoutReport = __webpack_require__(2);

var _seeTryoutReport2 = _interopRequireDefault(_seeTryoutReport);
...
_seeTryoutReport2.default.el = '#root';
new Vue(_seeTryoutReport2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\tryout\\seeTryoutReport.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-ab4bfaa4"
...
var promptModule = weex.requireModule("promptModule");
// const Steve = new BroadcastChannel("tryout");
    ...
    getData: function getData() {
      ...
      this.Get(this.api().activity_report_detail, {
        ...
        if (res.data.code == "0") {
          ...
          _this.goodsImg = res.data.data.image;
          _this.score = res.data.data.score;
          _this.score_tips = res.data.data.score_tips;
          for (var i = 0; i < _this.list_one.length; i++) {
            for (var j = 0; j < _this.list_one[i].content.length; j++) {
              var checkval = _this.list_one[i].content[j].checkval.toString();
              _this.base_info.push({
                id: _this.list_one[i].content[j].id,
                checkval: _this.list_one[i].content[j].checkval.toString(),
                is_statistic: _this.list_one[i].content[j].is_statistic
              });
            }
          }
        } else {
