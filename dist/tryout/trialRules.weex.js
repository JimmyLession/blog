...
var _trialRules = __webpack_require__(2);

var _trialRules2 = _interopRequireDefault(_trialRules);
...
_trialRules2.default.el = '#root';
new Vue(_trialRules2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\tryout\\trialRules.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2a9c1486"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("本次svisso试用仅限高级VIP开放、价格免费（先付款后退款）、数量50份抢完即止（仅限国内用户）")]), _c('text', {
    staticStyle: {
      fontSize: "28px",
      color: "#333333",
      fontWeight: "700",
  ...
  }, [_vm._v("1.立即申请  →  2.付款拍下试用商品  →  3.确认收货")]), _c('text', {
    staticStyle: {
      fontSize: "24px",
      color: "#333333",
      marginTop: "20px"
    }
  }, [_vm._v("4.提交试用报告  →  5.等待全额退款")]), _c('text', {
    staticStyle: {
      fontSize: "24px",
      color: "#666666",
      lines: "3",
  ...
  }, [_vm._v("退款途径：试用活动的退款将在提交试用报告，通过审核后的7个工作日内，系统自动打款至账户可提现余额，请注意查收！（有问题请联系客服）")])])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
