...
_region2.default.el = '#root';
new Vue(_region2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\region\\region.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-21705bcf"
...
var region = new BroadcastChannel('region');
exports.default = {
    ...
    methods: {
        itemClicked: function itemClicked(area_code) {
            var _this2 = this;

            if (this.from == 'ticket') {
                region.postMessage(area_code);
                this.popBar();
            } else {
                storage.setItem('area_code', area_code, function (event) {
    ...
    created: function created() {
        ...
        _this.isIpx(_this);
        _this.Get(_this.api().area_code, {}, function (res) {
            if (res.data.code == '0') {
                _this.data = res.data.data.item;
                _this.list = res.data.data.hot;
            }
        });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.version) ? _c('title', {
    ...
    return (_vm.list.length != 0) ? _c('cell', {
      key: i,
      ref: 'index-item-title-' + _vm.title,
      refInFor: true,
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      on: {
        "click": function($event) {
          _vm.itemClicked(item.area_code)
        }
      }
    }, [_c('text', {
      staticClass: ["name"]
      ...
      staticClass: ["desc"]
    }, [_vm._v(_vm._s(item.area_code))])]), _vm._m(0, true)]) : _vm._e()
  }), _vm._l((_vm.data), function(v, j) {
    return (_vm.data.length != 0) ? _c('cell', {
      key: j,
      ref: 'index-item-title-' + v.alpha,
      refInFor: true,
      appendAsTree: true,
      attrs: {
        "append": "tree"
      ...
      staticClass: ["hot_title"]
    }, [_vm._v(_vm._s(v.alpha))]), _vm._l((v.item), function(content, index) {
      return _c('div', {
        key: index,
        staticClass: ["index-vertical-item"],
        on: {
          "click": function($event) {
            _vm.itemClicked(content.area_code)
          }
        }
      }, [_c('div', {
        staticClass: ["index-list-item"]
        ...
        staticClass: ["name"]
      }, [_vm._v(_vm._s(content.name))]), _c('text', {
        staticClass: ["desc"]
      }, [_vm._v(_vm._s(content.area_code))])]), _vm._m(1, true)])
    })], 2) : _vm._e()
    ...
    return _c('text', {
      ...
      on: {
        "click": function($event) {
          _vm.go2Key(item.alpha)
        }
      }
    }, [_vm._v(_vm._s(item.alpha))])
  })), (_vm.popKeyShow) ? _c('div', {
