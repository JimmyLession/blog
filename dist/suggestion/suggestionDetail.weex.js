...
var _suggestionDetail = __webpack_require__(2);

var _suggestionDetail2 = _interopRequireDefault(_suggestionDetail);
...
_suggestionDetail2.default.el = '#root';
new Vue(_suggestionDetail2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\suggestion\\suggestionDetail.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-539f9d00"
...
var bottom = 0;
exports.default = {
    components: { titleBar: _titleBar2.default, line: _line2.default, empty: _empty2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
            type: '', //判断当前的是投诉客服详情还是反馈建议详情
            id: '', //当前详情的id
            data: '' //数据详情
        };
    },
    ...
    methods: {
        getCustomerDetail: function getCustomerDetail() {
            //获取投诉的列表的详情
            var self = this;
            self.Get(self.api().customerDetail, {
                id: self.id
            }, function (res) {
                if (res.data.code == 0) {
        ...
        getSuggestDetail: function getSuggestDetail() {
            //获取反馈的列表的详情
            var self = this;
            self.Get(self.api().suggestDetail, {
                id: self.id
            }, function (res) {
                if (res.data.code == 0) {
                    // console.log(res.data.data);
    ...
    created: function created() {
        ...
        this.isIpx(this);
        var self = this;
        self.type = self.GetUrlPara(weex.config.bundleUrl, 'type');
        self.id = self.GetUrlPara(weex.config.bundleUrl, 'id');
        if (self.type == 1) {
            self.getCustomerDetail();
        } else {
            self.getSuggestDetail();
        }
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("关于投诉客服" + _vm._s(_vm.data.customer_name) + "的处理情况")]), _c('text', {
    class: ['right-text', _vm.data.process_status == 0 ? 'status-color' : 'status-color2']
  }, [_vm._v(_vm._s(_vm.data.process_status_name))])]) : _vm._e(), (_vm.type == 1) ? _c('div', {
    staticClass: ["detail-info"]
  }, [_c('div', {
    staticClass: ["tousu-info"]
  }, [_c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("投诉日期：")]), _c('text', {
    ...
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.nickname))])]), _c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("被投诉人：")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.customer_name))])]), _c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("投诉类别：")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.complaint_type_name))])])]), _c('div', {
    staticClass: ["handle-info"]
  }, [(_vm.data.updated_at) ? _c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("处理日期：")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.updated_at))])]) : _vm._e(), _c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("处理情况：")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.process_status_name))])]), (_vm.data.process_remarks) ? _c('div', {
    staticClass: ["common"]
  }, [_c('text', {
    staticClass: ["left-text", "left-text-width"]
  }, [_vm._v("处理结果：")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.process_remarks))])]) : _vm._e()])]) : _vm._e(), (_vm.type == 2) ? _c('div', {
    staticClass: ["title-info"]
  }, [_c('text', {
    staticClass: ["left-text"]
  }, [_vm._v("关于反馈建议的处理情况")]), _c('text', {
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.process_status_name))])]) : _vm._e(), (_vm.type == 2) ? _c('div', {
    staticClass: ["detail-info"]
  }, [_c('div', {
    staticClass: ["tousu-info"]
  }, [_c('div', {
    ...
    staticClass: ["right-text"]
  }, [_vm._v(_vm._s(_vm.data.process_remarks))])]) : _vm._e()])]) : _vm._e()])], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
