...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\suggestion\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-8ef95352"
...
exports.default = {
    ...
    methods: {
        ...
        jumpToKf: function jumpToKf(reason) {
            //跳转到投诉客服
            this.jumpTo2("suggestion/complainKF", "", { reason: reason, select: true });
        },
        jumpToFeedback: function jumpToFeedback(suggestion) {
            //跳转到反馈和建议
            this.jumpTo2("suggestion/feedback", "", { suggestion: suggestion, select: true });
        },
        jumpTosuggestionDetail: function jumpTosuggestionDetail(type, id) {
            //跳转到投诉建议详情
            this.jumpTo2("suggestion/suggestionDetail", "", { type: type, id: id });
        },
        getCustomerList: function getCustomerList() {
            //获取投诉、反馈的列表
            var self = this;
            self.Get(self.api().customerList, {}, function (res) {
                if (res.data.code == 0) {
    ...
    created: function created() {
        ...
        event.onmessage = function (event) {
            if (!event.data) {
                ...
                if (event.data == self.eventBusTag().FEEDBACK || event.data == self.eventBusTag().COMPLAINKF) {
                    self.items = '';
                    self.getCustomerList();
                }
            }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["custom-service"]
  }, [_c('div', {
    staticClass: ["custom-service-left"],
    on: {
    ...
    staticClass: ["kf-img"],
    attrs: {
      "src": "http://img.abmau.com/abmau/0ac65e8c5db7d981514fd9c28c535d73.png"
    }
  }), _vm._m(0)]), _c('div', {
    staticClass: ["custom-service-center"]
  }, [_c('text', {
    staticClass: ["reason-text1", "reason-text-common"],
    on: {
      "click": function($event) {
        _vm.jumpToKf('态度较差')
      }
    ...
    staticClass: ["reason-text2", "reason-text-common"],
    on: {
      "click": function($event) {
        _vm.jumpToKf('处理不及时')
      }
    ...
    staticClass: ["custom-service-right"]
  }, [_c('text', {
    staticClass: ["reason-text1", "reason-text-common"],
    on: {
      "click": function($event) {
    ...
    staticClass: ["reason-text-common"],
    on: {
      "click": function($event) {
        _vm.jumpToKf('未解决问题')
      }
    ...
    staticClass: ["kf-img"],
    attrs: {
      "src": "http://img.abmau.com/abmau/58ea41fa25e0a810d78f6c9445c2b2e9.png"
    }
  }), _vm._m(1)]), _c('div', {
    staticClass: ["custom-service-center"]
  }, [_c('text', {
    ...
    on: {
      "click": function($event) {
        _vm.jumpToFeedback('功能建议')
      }
    }
  }, [_vm._v("功能建议")])])]), _vm._m(2), _c('list', [_c('refresher', {
    on: {
    ...
    return _c('cell', {
      ...
      on: {
        "click": function($event) {
          _vm.jumpTosuggestionDetail(item.type, item.id)
        }
      }
    }, [(item.type == 1) ? _c('div', {
      staticClass: ["handle-status", "handle-common"]
    }, [_c('text', {
      staticClass: ["text-common"]
    }, [_vm._v("关于投诉客服" + _vm._s(item.customer_name) + "的处理情况")]), _c('text', {
      class: ['text-common', item.process_status == 0 ? 'status-color' : 'status-color2']
    }, [_vm._v(_vm._s(item.process_status_name))])]) : _vm._e(), (item.type == 1) ? _c('div', {
      staticClass: ["handle-reason", "handle-common"]
    }, [_c('text', {
      staticClass: ["text-common"]
    }, [_vm._v("投诉原因：客服" + _vm._s(item.complaint_type_name))])]) : _vm._e(), (item.type == 1) ? _c('div', {
      staticClass: ["handle-detail", "handle-common"]
    }, [_c('text', {
      staticClass: ["handle-detail-text"]
    }, [_vm._v("反馈时间：" + _vm._s(item.created_at))]), _vm._m(3, true)]) : _vm._e(), (item.type == 2) ? _c('div', {
      staticClass: ["handle-status", "handle-common"]
    }, [_c('text', {
      staticClass: ["text-common"]
    }, [_vm._v("关于反馈建议的处理情况")]), _c('text', {
      class: ['text-common', item.process_status == 0 ? 'status-color' : 'status-color2']
    }, [_vm._v(_vm._s(item.process_status_name))])]) : _vm._e(), (item.type == 2) ? _c('div', {
      staticClass: ["handle-reason", "handle-common"]
    }, [_c('text', {
      staticClass: ["text-common"]
    }, [_vm._v("反馈类型：" + _vm._s(item.complaint_type_name))])]) : _vm._e(), (item.type == 2) ? _c('div', {
      staticClass: ["handle-detail", "handle-common"]
    }, [_c('text', {
      staticClass: ["handle-detail-text"]
    }, [_vm._v("反馈时间：" + _vm._s(item.created_at))]), _vm._m(4, true)]) : _vm._e()])
  }), (_vm.items.length == 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  return _c('div', {
    staticClass: ["my-suggestion"]
  }, [_c('text', {
    staticClass: ["my-suggestion-text"]
  }, [_vm._v("反馈列表")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["handle-detail-more"]
  }, [_c('text', {
    staticClass: ["handle-detail-text"]
