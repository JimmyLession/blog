...
var _success = __webpack_require__(2);
...
_success2.default.el = '#root';
new Vue(_success2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\suggestion\\success.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-484f25c8"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["text1"]
  }, [_vm._v("我们已收到您的反馈  感谢您对单创的支持")]), _c('text', {
    staticClass: ["text2"]
  }, [_vm._v("您可以在“反馈与建议处理结果”查看")]), _c('div', {
    staticClass: ["btn"]
  }, [_c('text', {
    staticClass: ["check-handle", "common"],
    on: {
      "click": function($event) {
        _vm.jumpToIndex()
      }
    }
  }, [_vm._v("查看处理情况")]), _c('text', {
    staticClass: ["common", "return"],
    on: {
      "click": function($event) {
        _vm.jumpToPersonal()
      }
