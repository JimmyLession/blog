...
var _helpCenter = __webpack_require__(2);
...
_helpCenter2.default.el = '#root';
new Vue(_helpCenter2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\help\\helpCenter.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-67d96c24"
...
exports.default = {
    ...
    methods: {
        openQuestionList: function openQuestionList(item) {
            this.jumpTo2('help/helpQuestionList', '', { title: item.title, typeId: item.typeId });
        },
        search: function search() {
            this.jumpTo2('help/questionSearch', '', {});
        },
        getData: function getData() {
            var _this = this;
            _this.Get(_this.api().rule_type_list, {
                type: 2
            }, function (res) {
                if (res.data.code == 0) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("搜索您想知道的")])]), _c('div', {
    style: {
      marginTop: '26px'
    }
  }, [_c('line'), _vm._l((_vm.data), function(item, index) {
    return _c('div', {
      key: index
    }, [_c('div', {
      style: {
      ...
      staticClass: ["right-ui"]
    }, [_c('div', {
      staticClass: ["right-parent"]
    }, _vm._l((item.title_data), function(title_data, i) {
      return (item.title_data && item.title_data.length > 0) ? _c('div', {
        key: i,
        on: {
          "click": function($event) {
            _vm.showDetails(title_data)
          }
        }
      }, [(i < 4) ? _c('text', {
        staticClass: ["right-text"]
      }, [_vm._v(_vm._s(title_data.title))]) : _vm._e()]) : _vm._e()
    })), _c('div', {
      staticClass: ["line"],
      style: {
        position: 'absolute',
