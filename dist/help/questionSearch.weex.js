...
var _questionSearch = __webpack_require__(2);

var _questionSearch2 = _interopRequireDefault(_questionSearch);
...
_questionSearch2.default.el = '#root';
new Vue(_questionSearch2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\help\\questionSearch.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-28910b5c"
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            page: 1,
            limit: 20,
            key: 'history_search_data'
        };
    },

    methods: {
        openQuestionList: function openQuestionList() {
            this.jumpTo2('help/helpQuestionList', '', { title: '物流问题' });
        },
        ...
        getData: function getData() {
            var _this = this;
            _this.Get(_this.api().help_hot_keyword, {}, function (res) {
                if (res.data.code == 0) {
        ...
        showDetails: function showDetails(item) {
            this.jumpTo2('help/helpQuestionDetails', '', { id: item.id });
        },
        search: function search(event) {
            var _this = this;
            if (event.value) {
                _this.getSearchData(event.value);
            } else {
        ...
        getSearchData: function getSearchData(value) {
            var _this = this;
            _this.isSearch = true;
            _this.Get(_this.api().search_help_data, {
                keyword: value,
                offset: _this.page,
                limit: _this.limit
            }, function (res) {
        ...
        feedback: function feedback() {
            this.jumpTo2("suggestion/feedback", "", { suggestion: '问题反馈', select: true });
        }
    },
    created: function created() {
        ...
        _this.getData();
        storage.getItem(_this.key, function (event) {
            if (event.data && event.data != 'undefined') {
                _this.historyData = event.data;
            }
        });
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, 'input', _vm.inputValue, false))]), _c('div', {
    on: {
    ...
    staticClass: ["cancel"],
    style: {
      lineHeight: (_vm.titleHeight - 20) + 'px'
    }
  }, [_vm._v("取消")])])]), _c('line')], 1), _c('div', {
    staticClass: ["parent"],
    style: {
      top: _vm.height + 'px',
      bottom: _vm.bottom + 'px'
    }
  }, [(_vm.isSearch) ? _c('list', [_vm._l((_vm.searchData), function(item, index) {
    return (_vm.searchData && _vm.searchData.length > 0) ? _c('cell', {
      key: index,
      appendAsTree: true,
      attrs: {
        "append": "tree"
    ...
    })]), (index != (_vm.searchData.length - 1)) ? _c('line') : _vm._e()], 1) : _vm._e()
  }), (_vm.searchData && _vm.searchData.length <= 0) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    attrs: {
      "src": "http://img.abmau.com/abmau/c71d1bd3673c576dfb33de31661a7ac2.png"
    }
  }), _c('text', {
    staticClass: ["empty-text"]
  }, [_vm._v("没有找到您想要的问题，可点击下方反馈按钮")]), _c('text', {
  ...
  }, [_vm._v("点击反馈")])]) : _vm._e()], 2) : _c('div', [(_vm.historyData && _vm.historyData.length > 0) ? _c('div', [_vm._m(0), _c('div', {
    staticClass: ["search-content"]
  }, _vm._l((_vm.historyData), function(item, index) {
    return _c('div', {
      key: index
    }, [_c('text', {
      staticClass: ["search-content-text"]
    }, [_vm._v(_vm._s(item))])])
