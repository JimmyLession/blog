...
var _helpQuestionList = __webpack_require__(2);

var _helpQuestionList2 = _interopRequireDefault(_helpQuestionList);
...
_helpQuestionList2.default.el = '#root';
new Vue(_helpQuestionList2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\help\\helpQuestionList.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c40b0e9a"
...
var bottom = 0;
exports.default = {
    components: { title: _titleBar2.default, line: _line2.default, refresher: _refresh2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
    ...
    created: function created() {
        ...
        _this.typeId = _this.GetUrlPara(weex.config.bundleUrl, 'typeId');
        _this.getData();
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    })]), (index != (_vm.data.length - 1)) ? _c('line') : _vm._e()], 1)
  }), _c('cell', {
    staticClass: ["spec"],
    appendAsTree: true,
    attrs: {
  ...
  }), (_vm.data && _vm.data.length >= 20) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["loading-over-txt"]
  }, [_vm._v("已经全部加载完毕")]) : _vm._e()])]) : _vm._e()], 2) : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
