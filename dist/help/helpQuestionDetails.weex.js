...
var _helpQuestionDetails = __webpack_require__(2);

var _helpQuestionDetails2 = _interopRequireDefault(_helpQuestionDetails);
...
_helpQuestionDetails2.default.el = '#root';
new Vue(_helpQuestionDetails2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\help\\helpQuestionDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b69b1b86"
...
exports.default = {
    ...
    methods: {
        getData: function getData() {
            var _this = this;
            _this.Get(_this.api().help_detail, {
                id: _this.id
            }, function (res) {
                if (res.data.code == 0) {
                    _this.data = res.data.data;
                    _this.select_type = res.data.data.select_type;
                } else {
                    promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                }
            });
        },
        selectStatus: function selectStatus(type) {
            var _this = this;
            loadingModule.show({ msg: '' });
            var select_type = 0;
            if (type == 1 && _this.select_type != 1) {
                select_type = 1;
            } else if (type == 2 && _this.select_type != 2) {
                select_type = 2;
            }
            _this.Post(_this.api().help_user_helpful, {
                ...
                loadingModule.cancel(function (ret) {
                    ...
                    if (result == 'dismiss') {
                        if (res.data.code == 0) {
                            _this.select_type = select_type;
                            if (_this.select_type == 2) {
                                modal.toast({ message: '有问题请联系在线客服！', duration: 3 });
                            }
                        } else {
                            promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["question-status"],
    attrs: {
      "src": "http://img.abmau.com/abmau/f8476396a511871c6e1d50de44b43e1e.png"
    }
  }), _c('text', {
    ...
    staticClass: ["question-status-reponse"],
    attrs: {
      "src": "http://img.abmau.com/abmau/f7d47337df807ea1e14cab8afd7ebd7b.png"
    }
  }), _c('abm-web', {
    ref: "web",
    staticClass: ["question-text"],
  ...
  }, [(_vm.select_type != 1) ? _c('image', {
    staticClass: ["status-icon"],
    attrs: {
      "src": "http://img.abmau.com/abmau/3cf555ded7a64d095988f2d8acc85c18.png"
    }
  }) : _c('image', {
    staticClass: ["status-icon"],
    attrs: {
      "src": "http://img.abmau.com/abmau/10fc0aaf029260791a42c418cffd4d7c.png"
    }
  }), _c('text', {
    staticClass: ["status-text"],
    style: {
      color: _vm.select_type == 1 ? '#CF1126' : '#666666'
    }
  }, [_vm._v("有帮助")])]), _c('div', {
    staticClass: ["status"],
    on: {
  ...
  }, [(_vm.select_type != 2) ? _c('image', {
    staticClass: ["status-icon"],
    attrs: {
      "src": "http://img.abmau.com/abmau/61922fdf328f20660be8e0ef31cdf1fe.png"
    }
  }) : _c('image', {
    staticClass: ["status-icon"],
    attrs: {
      "src": "http://img.abmau.com/abmau/8accf3f760378df060df1225c4bde37e.png"
    }
  }), _c('text', {
    staticClass: ["status-text"],
    style: {
      color: _vm.select_type == 2 ? '#333333' : '#666666'
    }
  }, [_vm._v("没帮助")])])])]) : _vm._e()], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
