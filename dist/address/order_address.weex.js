...
var _order_address = __webpack_require__(2);
...
_order_address2.default.el = '#root';
new Vue(_order_address2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\address\\order_address.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-04150ae4"
...
var _refresh = __webpack_require__(13);
...
var goodsAddress = new BroadcastChannel('goods_select_address');
var storage = weex.requireModule('storage');
var Steve = new BroadcastChannel("address");
var deleteAddress = new BroadcastChannel("delete_address");
exports.default = {
    components: { title: _titleBar2.default, line: _line2.default, refresher: _refresh2.default, empty: _empty2.default, WxcSearchbar: _search2.default },
    data: function data() {
        return {
            isStart: true,
            isHint: false,
    ...
    methods: {
        ...
        pop: function pop(item) {
            var _this = this;
            if (_this.from == 1) {
                _this.Get(_this.api().check_address_info, {
                    ...
                    if (res.data.code == 0) {
                        ...
                        goodsAddress.postMessage({ goodsId: id, addressName: item.province.name + item.city.name + item.district.name + item.address, addressId: item.id });
                        _this.popBar();
                    } else {
                ...
                storage.setItem('address_id', item.id, function (event) {
                    if (event.result == 'success') {
                        address.postMessage(_this.eventBusTag().REFRESH_ADDRESS);
                        _this.popBar();
                    }
                });
            }
        ...
        edit_address: function edit_address(address_id) {
            this.jumpTo2("address/address_list", "", { id: address_id, title: "编辑地址", type: 'edit' });
        },

        //添加地址
        add_address: function add_address() {
            if (this.from == 1) {
                this.jumpTo2("address/revamp_address", "", { id: 0, title: "新增地址", type: 'default' });
            } else {
                this.jumpTo2("address/revamp_address", "", { id: 0, title: "新增地址", type: 'list' });
            }
        },
        ...
        requestData: function requestData() {
            ...
            _this.Get(_this.api().user_brandprovider_address_list, {
                ...
                if (res.data.code == "0") {
                    ...
                    if ((!_this.address_data || _this.address_data.length == 0) && _this.page == 1) {
                        if (!_this.keyword || _this.keyword == "") {
                            address.postMessage(_this.eventBusTag().RESET_ADDRESS);
                            _this.isHint = true;
                            _this.searchHeight = 0;
                        }
                        _this.emptyShow = true;
                    } else {
                        _this.isHint = false;
                        _this.searchHeight = 90;
                        _this.emptyShow = false;
                    }
                } else {
                    promptModule.showPrompt({ msg: res.data.msg, type: "err" });
    ...
    created: function created() {
        ...
        this.from = this.GetUrlPara(weex.config.bundleUrl, 'from');
        this.goods_id = this.GetUrlPara(weex.config.bundleUrl, 'goods_id');
        if (!this.from) {
            this.from = 0;
        }
        this.requestData();
        var _this = this;
        deleteAddress.onmessage = function (event) {
            if (!event.data) {
                return;
            }
            switch (event.data) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    on: {
      ...
      "wxcMinibarRightButtonClicked": function($event) {
        _vm.edit_address(_vm.address_id)
      }
    }
  ...
  }), _vm._l((_vm.address_data), function(item, i) {
    return (_vm.address_data && _vm.address_data.length > 0) ? _c('cell', {
      key: i,
    ...
    }, [(_vm.address_id == item.id) ? _c('div', {
      staticClass: ["left_select_item"]
    }) : _vm._e()]), _c('div', {
    ...
    }, [_vm._v(_vm._s(item.province.name + item.city.name + item.district.name + item.address))])])]), _c('div', {
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.loading && _vm.address_data.length > 8) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
    ...
    staticClass: ["loading-over-txt"]
  }, [_vm._v("已经全部加载完毕")]) : _vm._e()])]) : _vm._e()], 2), _c('text', {
