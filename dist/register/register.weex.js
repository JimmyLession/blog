...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\register\\register.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-3e30a12f"
...
exports.default = {
    ...
    created: function created() {
        ...
        this.name = this.GetUrlPara(weex.config.bundleUrl, 'name');
        this.tel = this.GetUrlPara(weex.config.bundleUrl, 'tel');
        this.invite_code = this.GetUrlPara(weex.config.bundleUrl, 'invite_code');
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("分享人姓名")]), _c('text', {
    staticClass: ["name_title"]
  }, [_vm._v(_vm._s(_vm.name))])]), _c('line'), _c('div', {
    staticClass: ["name"]
  }, [_c('text', {
    staticClass: ["name_title"]
  }, [_vm._v("分享人手机号")]), _c('text', {
    staticClass: ["name_title"]
  }, [_vm._v(_vm._s(_vm.tel))])]), _c('line'), _c('text', {
    staticClass: ["back"],
    on: {
      "click": function($event) {
        _vm.clickBack()
