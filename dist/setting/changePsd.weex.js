...
var _changePsd = __webpack_require__(2);

var _changePsd2 = _interopRequireDefault(_changePsd);
...
_changePsd2.default.el = '#root';
new Vue(_changePsd2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\setting\\changePsd.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6c47d358"
...
exports.default = {
    ...
    created: function created() {
        ...
        _this.isIpx(_this);
        _this.mobile = decodeURIComponent(this.GetUrlPara(weex.config.bundleUrl, 'mobile'));
    ...
    methods: {
        onInputOldPsd: function onInputOldPsd(e) {
            this.oldPsd = e.value;
            this.isParam = this.isValueParam(this, [this.oldPsd, this.psd, this.againPsd, this.code]);
        },
        onInputPsd: function onInputPsd(e) {
            this.psd = e.value;
            this.isParam = this.isValueParam(this, [this.oldPsd, this.psd, this.againPsd, this.code]);
        },
        onInputAgainPsd: function onInputAgainPsd(e) {
            this.againPsd = e.value;
            this.isParam = this.isValueParam(this, [this.oldPsd, this.psd, this.againPsd, this.code]);
        },
        ...
        sendCode: function sendCode() {
            ...
            if (!_this.mobile) {
                promptModule.showPrompt({ msg: '未获取到手机号码', type: 'err' });
                return;
            }
            var mobileData = _this.mobile;
            if (mobileData.startsWith("+")) mobileData = mobileData.replace("+", "%2B");
        ...
        alterCode: function alterCode() {
            this.jumpTo2('other/codeHelp', '', { mobile: this.mobile, type: this.mobile });
        },
        commit: function commit() {
            var _this = this;
            if (!_this.oldPsd) {
                promptModule.showPrompt({ msg: '请输入现在密码', type: 'prompt' });
                return;
            } else if (!_this.psd) {
                promptModule.showPrompt({ msg: '请输入新的密码', type: 'prompt' });
                return;
            } else if (!_this.againPsd) {
                promptModule.showPrompt({ msg: '请再次输入新的密码', type: 'prompt' });
                return;
            } else if (_this.psd != _this.againPsd) {
                promptModule.showPrompt({ msg: '新密码与确认新密码不一致', type: 'prompt' });
                return;
            } else if (!_this.code) {
                promptModule.showPrompt({ msg: '请输入短信验证码', type: 'prompt' });
                return;
            }
            _this.md5(_this.oldPsd, function (ret) {
                _this.md5(_this.psd, function (event) {
                    var areaCode = _this.mobile;
                    if (areaCode.startsWith("+")) areaCode = areaCode.replace("+", "%2B");
                    _this.Post(_this.api().change_password, {
                        old_password: ret.md5,
                        mobile: areaCode,
                        password: event.md5,
                        code: _this.code
                    }, function (res) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "onInput": _vm.onInputPsd
    }
  })], 1), _c('line'), _c('div', {
    staticClass: ["item"]
  }, [_c('text', {
    staticClass: ["text"]
  }, [_vm._v("确认新密码")]), _c('edit', {
    ref: "inputPsdAgain",
    staticClass: ["input_psd"],
    attrs: {
      "type": "password",
  ...
  }, [_vm._v(_vm._s(_vm.codeName))])], 1), _c('div', {
    style: {
      height: 100 + 'px'
    }
  }), _c('div', {
    ...
    staticClass: ["code_hint"]
  }, [_vm._v(_vm._s(_vm.codeHint))]), (_vm.is_show) ? _c('text', {
    staticClass: ["voice_hint"]
  }, [_vm._v("*验证码已发送至" + _vm._s(_vm.mobile) + ",请注意接听")]) : _vm._e(), _c('wx-button', {
    attrs: {
      "marginTop": "120",
      "content": "提交",
