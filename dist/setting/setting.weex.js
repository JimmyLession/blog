...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\setting\\setting.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c0ccce12"
...
exports.default = {
    ...
    methods: {
        ...
        getData: function getData() {
            var _this = this;
            _this.Get(_this.api().get_user_info, {}, function (res) {
                if (res.data.code == 0) {
        ...
        showMineInfoDot: function showMineInfoDot() {
            var _this = this;
            storage.getItem("abm_wx_qr_" + _this.id, function (res) {
                var abm_wx_qr = res.data;
                storage.getItem("abm_user_address_" + _this.id, function (ret) {
                    var abm_user_address = ret.data;
                    _this.showUserDot = !(_this.address != '' || _this.id == abm_user_address) || !(_this.id == abm_wx_qr || _this.qr_code_url != '');
                });
            });
        },
        ...
        account: function account() {
            this.jumpTo2('setting/accountManager', '', { title: '账户管理' });
        },
        ...
        identification: function identification() {
            if (this.verify == 0) this.jumpTo2('setting/identification', '', { isReIdentification: false, jumpFrom: 'settingList' });else this.jumpTo2('setting/identificationStatus', '', { statusFrom: 'settingList' });
        },
        ...
        clear_cache: function clear_cache() {
            var _this = this;
            utilModule.clearCache({}, function (res) {
                _this.cacheSize = res.cache_size;
                promptModule.showPrompt({ msg: "清除成功", type: 'success' });
            });
        },
         ...
         */
        help: function help() {
            this.jumpTo2('help/helpCenter', '', {});
            //titleBar.startWeb({title: '帮助中心', url: 'https://wap.abmau.com/app/help'});
        },

        /**
         * 服务协议
         */
        agreement: function agreement(title, url) {
            this.jumpTo2('web/webView', '', { title: title, url: encodeURIComponent(url) });
        },
        ...
        about_us: function about_us() {
            titleBar.startWeb({ title: '关于我们', url: 'https://wap.abmau.com/about' });
        },
        checkVersion: function checkVersion() {
            if (weex.config.env.platform.toLowerCase() === 'android') utilModule.upgradeApp();
        },
        authorize: function authorize() {
            this.jumpTo2('personal/authorize/authorizeList', '', { mobile: this.mobile });
        }
    },
    created: function created() {
        var _this = this;
        _this.id = decodeURIComponent(this.GetUrlPara(weex.config.bundleUrl, 'id'));
        _this.getTopHeight(_this);
        _this.isIpx(_this);
        _this.getData();
        _this.version = weex.config.env.appVersion;
        if (weex.config.env.platform.toLowerCase() === 'android') _this.androidInfo = "(点击检测版本)";else _this.androidInfo = "";
        utilModule.getCacheSize({}, function (res) {
            _this.cacheSize = res.size;
        });
        event.onmessage = function (event) {
            ...
            switch (event.data) {
                case _this.eventBusTag().REFRESH_MINE_INFO_DOT:
                    _this.showMineInfoDot();
                    break;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["hasContentText"]
  }, [_vm._v("个人信息")]), _c('div', {
    staticClass: ["identity"]
  }, [_c('text', {
    staticClass: ["identityText"]
  }), (_vm.showUserDot) ? _c('div', {
    staticClass: ["circle"]
  }) : _vm._e(), _c('image', {
    staticClass: ["next"],
    attrs: {
    ...
    staticClass: ["identity"]
  }, [(_vm.verify == 0) ? _c('text', {
    staticClass: ["identityText"]
  }, [_vm._v("未认证")]) : _vm._e(), (_vm.verify == 1) ? _c('text', {
    staticClass: ["identityText"]
  }, [_vm._v("认证中")]) : _vm._e(), (_vm.verify == 2) ? _c('text', {
    staticClass: ["identityText"]
  }, [_vm._v("已认证")]) : _vm._e(), (_vm.verify == 3) ? _c('text', {
    staticClass: ["identityText"]
  }, [_vm._v("未通过")]) : _vm._e(), (_vm.verify == 0 || _vm.verify == 3) ? _c('div', {
    staticClass: ["circle"]
  }) : _vm._e(), _c('image', {
    staticClass: ["next"],
    attrs: {
  ...
  }, [_vm._v(_vm._s(_vm.cacheSize))]), _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
    ...
    on: {
      "click": function($event) {
        _vm.agreement('用户服务协议', 'https://wap.abmau.com/abm_protocol.html')
      }
    }
  }, [_c('text', {
    staticClass: ["text"]
  }, [_vm._v("用户服务协议")]), _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
    ...
    on: {
      "click": function($event) {
        _vm.agreement('单创用户隐私权政策', 'https://wap.abmau.com/privacy_of_individual.html')
      }
    }
  }, [_c('text', {
    staticClass: ["text"]
  }, [_vm._v("单创用户隐私权政策")]), _c('image', {
    staticClass: ["next"],
    attrs: {
      "src": "http://img.abmau.com/abmau/197260145f13acf70e06fe37ad4ba0c8.png"
    }
  ...
  }, [_vm._v("当前App版本" + _vm._s(_vm.version) + _vm._s(_vm.androidInfo))])], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
