...
var _elevenActivities = __webpack_require__(2);

var _elevenActivities2 = _interopRequireDefault(_elevenActivities);
...
_elevenActivities2.default.el = '#root';
new Vue(_elevenActivities2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\activities\\elevenActivities.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-c6eacf60"
...
exports.default = {
    components: { title: _titleBar2.default, refresher: _refresh2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
    ...
    methods: {
        startWeb: function startWeb(title, url, shareUrl, shareTitle, shareDes, shareImg) {
        ...
        clickRules: function clickRules() {
            this.jumpTo2('web/webView', '', { url: encodeURIComponent('https://wap.abmau.com/app/recommend_list?article_id=332&app_version=3.4.3&token=e6e0d4bb0d92171e2937a62cfe3dcbea&parentCode=1095215'), title: '双十一出货排行榜奖励规则' });
        },
        fetch: function fetch() {
            var self = this;
            self.Get(self.api().double_rank, {}, function (res) {
                if (res.data.code == 0) {
                    self.topData = res.data.data.top;
                    self.img_url = res.data.data.rank.myself.img_url;
                    self.bottomData = res.data.data.bottom;
                } else {
                    promptModule.showPrompt({ msg: res.data.msg, type: 'err' });
                }
            });
        },
        rankInfo: function rankInfo() {
            var self = this;
            self.Get(self.api().paymentRank, {
                limit: 3,
                offset: 0
            }, function (res) {
                if (res.data.code == '0') {
                    self.rank.myself = res.data.data.user;
                    self.rank.list = res.data.data.list;
    ...
    created: function created() {
        ...
        if (!_this.from || _this.from == 'default') _this.mainBarHeight(_this);else _this.isIpx(_this);
        _this.fetch();
        _this.rankInfo();
    }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._l((_vm.topData), function(top) {
    return (_vm.topData.length != 0) ? _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
      ...
      style: {
        width: 750 + 'px',
        height: 750 * top.height / top.width + 'px'
      },
      attrs: {
        "src": top.image_url
      },
      on: {
        "click": function($event) {
          _vm.startWeb(top.title, top.url, top.sharelink, top.sharetitle, top.sharedesc, top.shareimg)
        }
      }
    })]) : _vm._e()
  }), _vm._l((_vm.bottomData), function(bottom) {
    return (_vm.bottomData.length != 0) ? _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
      ...
      style: {
        width: 750 + 'px',
        height: 750 * bottom.height / bottom.width + 'px'
      },
      attrs: {
      ...
      on: {
        "click": function($event) {
          _vm.startWeb(bottom.title, bottom.url, bottom.sharelink, bottom.sharetitle, bottom.sharedesc, bottom.shareimg)
        }
      }
    })]) : _vm._e()
  })], 2)])], 1)
