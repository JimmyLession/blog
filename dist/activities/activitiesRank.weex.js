...
var _activitiesRank = __webpack_require__(2);

var _activitiesRank2 = _interopRequireDefault(_activitiesRank);
...
_activitiesRank2.default.el = '#root';
new Vue(_activitiesRank2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\activities\\activitiesRank.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b305440a"
...
exports.default = {
    ...
    methods: {
        ...
        clickToCheckRankDetail: function clickToCheckRankDetail(event) {
            ...
            this.jumpTo2('web/webView', '', { url: encodeURIComponent('https://wap.abmau.com/app/help/rank2'), title: '双十一出货排行榜奖励规则' });
        },
        ...
        onloading: function onloading() {
            ...
            if (!_this.loading) {
                ...
                _this.offset = this.offset + 20;
                _this.fetch();
            }
        },
        fetch: function fetch() {
            var _this = this;
            _this.Get(_this.api().paymentRank, {}, function (res) {
                if (res.data.code == '0') {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["image"],
    attrs: {
      "src": "http://img.abmau.com/abmau/4525d3bfdeb96bee94ead23733ded640.png"
    },
    on: {
  ...
  }, [(_vm.user.rank == '' || _vm.user.rank == null || _vm.user.rank == '暂未上榜') ? _c('text', {
    staticClass: ["user_index"]
  }) : _vm._e(), (_vm.user.rank != '' && _vm.user.rank != null && _vm.user.rank != '暂未上榜') ? _c('text', {
    staticClass: ["user_index"]
  }, [_vm._v(_vm._s(_vm.user.rank))]) : _vm._e(), (_vm.user.head_image == '' || _vm.user.head_image == null) ? _c('image', {
    staticClass: ["user_head"],
    attrs: {
      "resize": "cover",
      "src": "assets://icon_user_placehold"
    }
  }) : _vm._e(), (_vm.user.head_image != '' && _vm.user.head_image != null) ? _c('image', {
    staticClass: ["user_head"],
    attrs: {
      "resize": "cover",
      "src": _vm.user.head_image
    }
  }) : _vm._e(), _c('div', {
    staticClass: ["name_show"]
  }, [(_vm.user.nickname != '' && _vm.user.nickname != null) ? _c('text', {
    staticClass: ["user_mobile"]
  }, [_vm._v(_vm._s(_vm.user.nickname))]) : _vm._e(), ((_vm.user.nickname == '' || _vm.user.nickname == null) && (_vm.user.name != '' && _vm.user.name != null)) ? _c('text', {
    staticClass: ["user_mobile"]
  }, [_vm._v(_vm._s(_vm.user.name))]) : _vm._e(), ((_vm.user.nickname == '' || _vm.user.nickname == null) && (_vm.user.name == '' || _vm.user.name == null)) ? _c('text', {
    staticClass: ["user_mobile"]
  }, [_vm._v(_vm._s(_vm.user.mobile))]) : _vm._e()])]), (_vm.user.rank != '' && _vm.user.rank != null && _vm.user.rank != '暂未上榜') ? _c('text', {
    staticClass: ["user_cnt_top"]
  }, [_vm._v("¥" + _vm._s(_vm.user.total))]) : _vm._e(), (_vm.user.rank == '' || _vm.user.rank == null || _vm.user.rank == '暂未上榜') ? _c('text', {
    staticClass: ["user_cnt_top"]
  }, [_vm._v("暂未上榜")]) : _vm._e()]), _c('div', {
    staticClass: ["diver"]
  })]), _c('header', {
    appendAsTree: true,
    attrs: {
    ...
    return _c('cell', {
    ...
    }, [(index == 0 || index == 1 || index == 2) ? _c('div', {
      staticClass: ["rank-list-image"]
    }, [(index == 0) ? _c('image', {
      staticStyle: {
        width: "36px",
        height: "42px"
      ...
      attrs: {
        "src": "http://img.abmau.com/abmau/7741a2cbefaf4a5e1c7b8a5d11bd8ad7.png"
      }
      ...
      attrs: {
        "src": "http://img.abmau.com/abmau/8cd58bf1a8dea07689459ae955d03ab8.png"
      }
    }) : _vm._e(), (index == 2) ? _c('image', {
      staticStyle: {
        width: "36px",
        height: "42px"
      },
      attrs: {
        "src": "http://img.abmau.com/abmau/a793d86b673df183e06e7ba42ccd613c.png"
      }
    }) : _vm._e(), _c('text', {
      staticClass: ["rank-list-text"]
    }, [_vm._v(_vm._s(index + 1))])]) : _vm._e(), (index != 0 && index != 1 && index != 2) ? _c('text', {
      staticClass: ["user_index"]
    }, [_vm._v(_vm._s(index + 1))]) : _vm._e(), (item.head_image == '' || item.head_image == null) ? _c('image', {
      staticClass: ["user_head"],
      attrs: {
        "resize": "cover",
        "src": "assets://icon_user_placehold"
    ...
    }, [_vm._v("¥" + _vm._s(item.total))])]), _c('line')], 1)])
  }), (_vm.empty) ? _c('cell', {
    style: {
      height: (_vm.height - 535) + 'px'
    },
    appendAsTree: true,
    attrs: {
      "append": "tree"
