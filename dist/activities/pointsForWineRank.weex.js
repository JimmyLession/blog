...
var _pointsForWineRank = __webpack_require__(2);

var _pointsForWineRank2 = _interopRequireDefault(_pointsForWineRank);
...
_pointsForWineRank2.default.el = '#root';
new Vue(_pointsForWineRank2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\activities\\pointsForWineRank.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-9bfd04ee"
...
var _refresh = __webpack_require__(17);
...
exports.default = {
    components: { titleBar: _titleBar2.default, line: _line2.default, empty: _empty2.default, refresher: _refresh2.default },
    data: function data() {
        return {
            strTitle: '招初级赢新品红酒排行榜',
            lastTimestamp: 0,
            bigImgURL: 'http://img.abmau.com/abmau/c5269998e2d13cf2e27ed309e99d1102.jpg', //顶部大图
            webTittle: '', //顶部大图-跳转web的title
            webUrl: '', //顶部大图-跳转web的url
            sharelink: '',
            shareimg: '',
            sharetitle: '',
            sharedesc: '',
    ...
    methods: {
        ...
        //顶部大图查看活动详情
        clickToCheckRankDetail: function clickToCheckRankDetail(event) {
            if (event.timestamp - this.lastTimestamp < 3000) return;
            this.lastTimestamp = event.timestamp;
            //this.jumpTo('web/webView','',{url:encodeURIComponent('https://wap.abmau.com/recommend_list?article_id=368'), title:'活动详情'});
            //this.jumpTo2('web/webImageView','',{url:encodeURIComponent('https://wap.abmau.com/recommend_list?article_id=368'), title:'活动规则', sharelink:this.sharelink, shareimg:this.shareimg, sharetitle:this.sharetitle, sharedesc:this.sharedesc});
        },
        ...
        fetch: function fetch() {
            var _this = this;
            loadingModule.show({ msg: '排行榜数据正在加载中...' });
            _this.Get(_this.api().wine_exchange, {}, function (res) {
                if (res.data.code == '0') {
                    loadingModule.cancel(function (ret) {
                        _this.allData = res.data.data;
                        if (res.data.data.self) {
                            _this.user = res.data.data.self;
                        } else {
                            _this.userShow = false;
                        }
                        _this.list = res.data.data.ranking;
                        //判断空页面
    ...
    created: function created() {
        ...
        this.isIpx(this);
        this.sharelink = this.GetUrlPara(weex.config.bundleUrl, 'sharelink');
        this.shareimg = this.GetUrlPara(weex.config.bundleUrl, 'shareimg');
        this.sharetitle = this.GetUrlPara(weex.config.bundleUrl, 'sharetitle');
        this.sharedesc = this.GetUrlPara(weex.config.bundleUrl, 'sharedesc');
        this.webTittle = this.GetUrlPara(weex.config.bundleUrl, 'sharetitle'); //顶部大图-跳转web的title
        this.webUrl = this.GetUrlPara(weex.config.bundleUrl, 'sharelink');
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }) : _vm._e(), (_vm.webUrl != '') ? _c('image', {
    staticClass: ["image"],
    attrs: {
      "src": _vm.bigImgURL
    },
    on: {
      "click": _vm.clickToCheckRankDetail
    }
  }) : _vm._e()]), _c('cell', {
    appendAsTree: true,
    attrs: {
    ...
    staticClass: ["black-font"]
  }, [_vm._v("目前已送出")]), _c('text', {
    staticClass: ["red-font"]
  }, [_vm._v(_vm._s(_vm.allData.send_number))]), _c('text', {
    staticClass: ["black-font"]
  }, [_vm._v("瓶 剩余")]), _c('text', {
    staticClass: ["red-font"]
  }, [_vm._v(_vm._s(_vm.allData.lave_number))]), _c('text', {
    staticClass: ["black-font"]
  }, [_vm._v("瓶")])]), _c('div', {
    staticClass: ["user"]
  }, [_c('div', {
    staticClass: ["user_content"]
  }, [(_vm.user.ranking == 0) ? _c('text', {
    staticClass: ["user_index"]
  }) : _vm._e(), (_vm.user.ranking != 0) ? _c('text', {
    staticClass: ["user_index"]
  }, [_vm._v(_vm._s(_vm.user.ranking))]) : _vm._e(), _c('image', {
    staticClass: ["user_head"],
    attrs: {
      "resize": "cover",
      "src": "assets://icon_empty_photo"
    }
  }), _c('div', {
    staticClass: ["name_show"]
  }, [_c('div', {
    staticClass: ["name_show_text"]
  }, [_c('text', {
    staticClass: ["user_mobile"]
  }, [_vm._v(_vm._s(_vm.user.nick_name))])]), (_vm.user.ranking == 0) ? _c('text', {
    staticClass: ["name_show_date"]
  }, [_vm._v("未上榜")]) : _vm._e()])]), _c('div', {
    staticClass: ["user-state"]
  }, [_c('text', {
    staticClass: ["user_cnt_top"]
  }, [_vm._v("经验值: " + _vm._s(_vm.user.integral))]), _c('text', {
    staticClass: ["user_cnt_top"]
  }, [_vm._v("红酒瓶数:" + _vm._s(_vm.user.number))])])]), _c('div', {
    staticClass: ["diver"]
  })]), _c('header', {
    appendAsTree: true,
    attrs: {
  ...
  }, [_vm._m(0), _c('line')], 1), _vm._l((_vm.list), function(item, index) {
    return _c('cell', {
      key: index,
      appendAsTree: true,
      attrs: {
      ...
      staticClass: ["user_index"]
    }, [_vm._v(_vm._s(index + 1))]), (item.head_image == '' || item.head_image == null) ? _c('image', {
      staticClass: ["user_head"],
      attrs: {
        "resize": "cover",
        "src": "assets://icon_empty_photo"
      }
    }) : _vm._e(), (item.head_image != '' && item.head_image != null) ? _c('image', {
      staticClass: ["user_head"],
      attrs: {
        "resize": "cover",
        "src": item.head_image
      ...
      staticClass: ["list-user-state"]
    }, [_c('text', {
      staticClass: ["user_cnt"]
    }, [_vm._v("经验值: " + _vm._s(item.integral))]), _c('text', {
      staticClass: ["user_cnt"]
    }, [_vm._v("红酒瓶数: " + _vm._s(item.number))])])]), _c('line')], 1)])
  }), (_vm.empty) ? _c('cell', {
    staticClass: ["parent"],
    style: {
      top: (_vm.height - 200) + 'px',
      bottom: _vm.bottom + 'px'
    },
    appendAsTree: true,
    attrs: {
  ...
  }, [_c('empty')], 1) : _vm._e(), (_vm.loading && _vm.list.length > 18) ? _c('cell', {
    appendAsTree: true,
    attrs: {
      "append": "tree"
    }
  ...
  }, [(_vm.allLoadingFinsh == false) ? _c('text', {
    staticClass: ["loading-over-txt"]
  }, [_vm._v("加载中...")]) : _vm._e(), (_vm.allLoadingFinsh == true) ? _c('text', {
    staticClass: ["loading-over-txt"]
  ...
  }, [_vm._v("红酒排行榜")]), _c('text', {
    staticClass: ["title_text_cnt"]
  })])
}]}
module.exports.render._withStripped = true
