...
var _instructionsInvoices = __webpack_require__(2);

var _instructionsInvoices2 = _interopRequireDefault(_instructionsInvoices);
...
_instructionsInvoices2.default.el = '#root';
new Vue(_instructionsInvoices2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\instructionsInvoices.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-b4abe19a"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: ["title1"]
  }, [_vm._v("一、发票换开")]), _c('text', {
    staticClass: ["content1"]
  }, [_vm._v("申请发票开具时，请详细填写开票内容，并认真核对，发票一旦开具后，不支持换开发票。")]), _c('text', {
    staticClass: ["title2"]
  }, [_vm._v("二、发票申请规则")]), _c('text', {
    staticClass: ["content2-first"]
  }, [_vm._v("1、系统支持3个月内订单的发票开具申请，超过3个月的，不再支持申请开票。")]), _c('text', {
    staticClass: ["content2-second"]
  }, [_vm._v(" 2、对澳洲仓发往新西兰和中国境内的商品，不支持开具澳洲发票。")])])
}]}
module.exports.render._withStripped = true
