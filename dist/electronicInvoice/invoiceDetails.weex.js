...
var _invoiceDetails = __webpack_require__(2);
...
_invoiceDetails2.default.el = '#root';
new Vue(_invoiceDetails2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\invoiceDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-63735e46"
...
module.exports = {
  ...
  "content-bottom-addressInformation": {
    "marginBottom": "30"
  },
  "content-more": {
    "width": "650",
...
var bottom = 0;
exports.default = {
    components: { title: _titleBar2.default },
    data: function data() {
        return {
            height: height,
            bottom: bottom,
            isMany: true, //本张发票是否包含多笔订单
            id: '', //当前发票的id
            data: '' //当前发票的所有数据
        };
    },
    ...
    methods: {
        ...
        //点击查看发票
        clickSeeInvoice: function clickSeeInvoice() {
            this.jumpTo2('electronicInvoice/invoiceImg', '', { id: this.id });
        },

        //点击查看多笔订单
        clickToSeeManyDetail: function clickToSeeManyDetail(id) {
            this.jumpTo2('electronicInvoice/invoiceManyDetails', '', { id: id });
        },

        //获取发票的详情
        getInvoiceDetail: function getInvoiceDetail() {
            var self = this;
            self.Get(self.api().invoice_detail_aus, {
                id: self.id
            }, function (res) {
                if (res.data.code == 0) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    staticClass: ["content-top-status", "commen"]
  }, [_c('text', {
    staticClass: ["content-top-status-title", "commen-title"]
  }, [_vm._v("发票状态")]), _c('text', {
    staticClass: ["content-top-status-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.status_name))])]), _c('div', {
    staticClass: ["content-top-time", "commen"]
  }, [_c('text', {
    staticClass: ["content-top-time-title", "commen-title"]
  }, [_vm._v("申请开票时间")]), _c('text', {
    staticClass: ["content-top-time-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.created_at))])])]), _c('div', {
    staticClass: ["content-bottom"]
  }, [_c('div', {
    staticClass: ["content-bottom-headType", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-headType-title", "commen-title"]
  }, [_vm._v("抬头类型")]), _c('text', {
    staticClass: ["content-bottom-headType-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.header_type_name))])]), _c('div', {
    staticClass: ["content-bottom-invoiceRise", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-invoiceRise-title", "commen-title"]
  }, [_vm._v("发票抬头")]), _c('text', {
    staticClass: ["content-bottom-invoiceRise-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.invoice_header))])]), (_vm.data.header_type) ? _c('div', {
    staticClass: ["content-bottom-invoiceRise", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-invoiceRise-title", "commen-title"]
  }, [_vm._v("ABN号")]), _c('text', {
    staticClass: ["content-bottom-invoiceRise-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.abn_number))])]) : _vm._e(), _c('div', {
    staticClass: ["content-bottom-invoiceContents", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-invoiceContents-title", "commen-title"]
  }, [_vm._v("发票内容")]), _c('text', {
    staticClass: ["content-bottom-invoiceContents-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.remarks))])]), _c('div', {
    staticClass: ["content-bottom-invoiceAmount", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-invoiceAmount-title", "commen-title"]
  }, [_vm._v("发票金额")]), _c('text', {
    staticClass: ["content-bottom-invoiceAmount-text", "commen-text"]
  }, [_vm._v("$" + _vm._s(_vm.data.invoice_money))])]), _c('div', {
    staticClass: ["content-bottom-addressInformation", "commen"]
  }, [_c('text', {
    staticClass: ["content-bottom-addressInformation-title", "commen-title"]
  }, [_vm._v("地址信息")]), _c('text', {
    staticClass: ["content-bottom-addressInformation-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.receive_address))])])]), (_vm.data.order_count > 1) ? _c('div', {
    staticClass: ["content-more"],
    on: {
      "click": function($event) {
        _vm.clickToSeeManyDetail(_vm.data.id)
      }
    }
  }, [_c('text', {
    staticClass: ["content-num"]
  }, [_vm._v("本张发票含" + _vm._s(_vm.data.order_count) + "笔订单")]), _c('text', {
    staticClass: ["see-more-detail"]
  }, [_vm._v("查看")])]) : _vm._e()])])], 1)
