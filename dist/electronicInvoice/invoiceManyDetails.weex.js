...
var _invoiceManyDetails = __webpack_require__(2);

var _invoiceManyDetails2 = _interopRequireDefault(_invoiceManyDetails);
...
_invoiceManyDetails2.default.el = '#root';
new Vue(_invoiceManyDetails2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\invoiceManyDetails.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-73055104"
...
module.exports = {
  ...
  "item-content-middle-list": {
    "flexDirection": "row",
    "justifyContent": "space-between",
    "marginBottom": "20"
  },
  "item-content-middle-list-title": {
    "width": "540",
    "color": "#666666",
    "fontSize": "28",
    "lineHeight": "42"
  },
  "item-content-middle-list-num": {
    "color": "#666666",
    "fontSize": "28"
  },
  "item-content-bottom": {
  ...
  "item-content-bottom-time": {
    "color": "#383838",
    "fontSize": "28"
  },
  "item-content-bottom-money": {
    "color": "#CF1126",
    "fontSize": "28"
  }
}
...
exports.default = {
    ...
    methods: {
        ...
        //通过发票id  获取多个订单的详情
        getAllOrderDetail: function getAllOrderDetail() {
            var self = this;
            self.Get(self.api().invoice_orders_detail, {
                id: self.id
            }, function (res) {
                if (res.data.code == 0) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    }, [_vm._v("订单号：" + _vm._s(items.sn))])]), _c('div', {
      staticClass: ["item-content-middle"]
    }, _vm._l((items.order_goods), function(item, index) {
      return _c('div', {
        key: index,
        staticClass: ["item-content-middle-list"]
      }, [_c('text', {
        staticClass: ["item-content-middle-list-title"]
      }, [_vm._v(_vm._s(item.name))]), _c('text', {
        staticClass: ["item-content-middle-list-num"]
      }, [_vm._v("× " + _vm._s(item.count))])])
    })), _c('div', {
      staticClass: ["item-content-bottom"]
    }, [_c('text', {
      staticClass: ["item-content-bottom-time"]
    }, [_vm._v("订单时间：" + _vm._s(items.created_at))]), _c('text', {
      staticClass: ["item-content-bottom-money"]
    }, [_vm._v("$" + _vm._s(items.aud_amount))])])])])
  }))], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
