...
var _applyInvoiceResult = __webpack_require__(2);

var _applyInvoiceResult2 = _interopRequireDefault(_applyInvoiceResult);
...
_applyInvoiceResult2.default.el = '#root';
new Vue(_applyInvoiceResult2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\applyInvoiceResult.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-6fda83e4"
...
var result = new BroadcastChannel('applyInvoiceResult'); //广播返回
...
exports.default = {
    ...
    data: function data() {
        return {
            height: height,
            bottom: bottom,
            // isPersonal:false,//判断当前申请发票信息是个人还是公司
            id: '', //当前发票的id
            data: '', //当前发票的所有数据
            isInvoiceOrderPage: false
    ...
    methods: {
        ...
        wxcMinibarLeftButtonClicked: function wxcMinibarLeftButtonClicked() {
            console.log('this.isInvoiceOrderPage++++' + this.isInvoiceOrderPage);
            if (this.isInvoiceOrderPage) {
                console.log("+++++++++kill3");
                this.kill(3);
            } else {
                console.log("++++++++++kill2");
        ...
        getInvoiceDetail: function getInvoiceDetail() {
            ...
            self.Get(self.api().invoice_detail_aus, {
                ...
                if (res.data.code == 0) {
                    ...
                    //申请发票是否成功=>成功 广播给订单详情页面 => 刷新订单详情页面
                    result.postMessage({ applyResult: true });
                } else {
    ...
    created: function created() {
        ...
        self.isInvoiceOrderPage = self.GetUrlPara(weex.config.bundleUrl, 'isInvoiceOrderPage') == 'undefined' ? false : true;
        self.getInvoiceDetail();
        utilModule.eventListener(function () {});
        var globalEvent = weex.requireModule('globalEvent');
        console.log('isInvoiceOrderPage++++' + self.isInvoiceOrderPage);
        globalEvent.addEventListener("geolocation", function (e) {
            if (self.isInvoiceOrderPage) {
                console.log("self.isInvoiceOrderPage==true");
                self.kill(3);
            } else {
                console.log("self.isInvoiceOrderPage==false");
                self.kill(2);
            }
        });
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('title', {
    ...
    on: {
      "wxcMinibarLeftButtonClicked": function($event) {
        _vm.wxcMinibarLeftButtonClicked()
      }
    }
  }), _c('div', {
    staticClass: ["parent"],
    ...
    staticClass: ["head-type", "commen", "border-bottom"]
  }, [_c('text', {
    staticClass: ["head-type-title", "commen-title"]
  }, [_vm._v("抬头类型")]), _c('text', {
    staticClass: ["head-type-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.header_type_name))])]), _c('div', {
    staticClass: ["invoice-money", "commen", "border-bottom"]
  }, [_c('text', {
    staticClass: ["invoice-money-title", "commen-title"]
  }, [_vm._v("开票金额")]), _c('text', {
    staticClass: ["invoice-money-text"]
  }, [_vm._v("$" + _vm._s(_vm.data.invoice_money))])]), (!_vm.data.header_type) ? _c('div', {
    staticClass: ["name", "commen", "border-bottom"]
  }, [_c('text', {
    staticClass: ["red"]
  }, [_vm._v("*")]), _c('text', {
    staticClass: ["name-title", "commen-title"]
  }, [_vm._v("姓名")]), _c('text', {
    staticClass: ["name-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.invoice_header))])]) : _vm._e(), (_vm.data.header_type) ? _c('div', {
    staticClass: ["name", "commen", "border-bottom"]
  }, [_c('text', {
    staticClass: ["red"]
  }, [_vm._v("*")]), _c('text', {
    ...
    staticClass: ["address", "commen"]
  }, [_c('text', {
    staticClass: ["address-title", "commen-title"]
  }, [_vm._v("地址信息")]), _c('text', {
    staticClass: ["address-text", "commen-text"]
  }, [_vm._v(_vm._s(_vm.data.receive_address))])]), _vm._m(3)])], 1)
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["invoice-type"]
  }, [_c('text', {
    staticClass: ["invoice-type-text"]
  }, [_vm._v("发票类型")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["gst"]
  }, [_c('text', {
    staticClass: ["gst-text"]
  }, [_vm._v("GST电子发票")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["invoice-type"]
  ...
  return _c('div', {
    ...
    staticClass: ["remarks-text"]
  }, [_vm._v("备注：您的开票申请已提交，我们会在1~2个工作日内完成开票。")])])
}]}
module.exports.render._withStripped = true
