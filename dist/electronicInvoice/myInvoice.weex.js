...
var _myInvoice = __webpack_require__(4);

var _myInvoice2 = _interopRequireDefault(_myInvoice);
...
_myInvoice2.default.el = '#root';
new Vue(_myInvoice2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\myInvoice.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0961e189"
...
var _titleBar = __webpack_require__(28);
...
var height = 0;
exports.default = {
    components: { WxcTabPage: _wxcTabPage2.default, titleBar: _titleBar2.default, refresher: _refresh2.default, line: _line2.default, empty: _empty2.default },
    data: function data() {
        return {
            title: '我的发票',
            tabTitles: [{
            ...
            limit: 10,
            offset: [0, 0],
            loading: [false, false], //加载中
            allLoadingFinish: [false, false], //数据是否全部加载完成
            emptyIsShow: [false, false],
            bgImgSrc: '',
            index: 0,
            type: 'all',
            data: [],
            tabList: [],
            isPass: true //待开发票审核是否通过
        };
    },
    ...
    methods: {
        ...
        //点击查看发票详情
        clickToDetail: function clickToDetail() {},
        ...
        fetch: function fetch(index) {
            //初始加载数据
            var _this = this;
            _this.Get(_this.api().withdraw_record, {
                ...
                if (res.data.code == '0') {
                    ...
                    } else _this.emptyIsShow[index] = false;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('list', {
      ...
      return (items.length != 0) ? _c('cell', {
      ...
      }, [(_vm.index == 0 || !_vm.isPass) ? _c('text', {
        staticClass: ["see-detail-text"],
        on: {
          "click": function($event) {
            _vm.clickToDetail()
          }
        }
      }, [_vm._v("查看详情    ")]) : _vm._e(), (_vm.index != 0 && _vm.isPass) ? _c('text', {
        staticClass: ["see-detail-text"],
        on: {
          "click": function($event) {
            _vm.clickToEdit()
        ...
        staticClass: ["content-detail-type", "commen", "margin-bottom"]
      }, [_c('text', {
        staticClass: ["commen-title"]
      }, [_vm._v("发票类型：")]), _c('text', {
        staticClass: ["commen-text"]
      }, [_vm._v("GST")])]), _c('div', {
        staticClass: ["content-detail-time", "commen", "margin-bottom"]
      }, [_c('text', {
        staticClass: ["commen-title"]
      }, [_vm._v("开票时间：")]), _c('text', {
        staticClass: ["commen-text"]
      }, [_vm._v("2018-12-4")])]), _c('div', {
        staticClass: ["content-detail-number", "commen", "margin-bottom"]
      }, [_c('text', {
        staticClass: ["commen-title"]
      }, [_vm._v("订单编号：")]), _c('text', {
        staticClass: ["commen-text"]
      }, [_vm._v("W2018042211015467867228832")])]), _c('div', {
        class: ['content-detail-title', 'commen', _vm.index == 0 ? '' : 'margin-bottom']
      }, [_c('text', {
        staticClass: ["commen-title"]
      }, [_vm._v("发票内容：")]), _c('text', {
        staticClass: ["commen-text"]
      }, [_vm._v("Vida Glow 经典原味深海胶原蛋白90g")])]), (_vm.index != 0) ? _c('div', {
        staticClass: ["content-detail-status", "commen"]
      }, [_c('text', {
        staticClass: ["commen-title"]
      }, [_vm._v("发票状态：")]), (_vm.isPass) ? _c('text', {
        staticClass: ["commen-text", "red"]
      }, [_vm._v("发票信息异常请重新填写")]) : _vm._e(), (!_vm.isPass) ? _c('text', {
        staticClass: ["commen-text", "black"]
      }, [_vm._v("审核中")]) : _vm._e()]) : _vm._e()])]) : _vm._e()
    }), (_vm.emptyIsShow[key]) ? _c('cell', {
      style: {
        height: (_vm.height - _vm.tabStyles.height) + 'px'
      },
      appendAsTree: true,
    ...
    }, [_c('empty')], 1) : _vm._e(), (_vm.loading[key] && items.length > 8) ? _c('cell', {
      appendAsTree: true,
      attrs: {
        "append": "tree"
      }
    ...
    }, [(!_vm.allLoadingFinish[key]) ? _c('text', {
      staticClass: ["loading-over-txt"]
    }, [_vm._v("加载中...")]) : _vm._e(), (_vm.allLoadingFinish[key]) ? _c('text', {
      staticClass: ["loading-over-txt"]
