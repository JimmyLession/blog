...
var _invoiceImg = __webpack_require__(2);

var _invoiceImg2 = _interopRequireDefault(_invoiceImg);
...
_invoiceImg2.default.el = '#root';
new Vue(_invoiceImg2.default);
...
__vue_options__.__file = "F:\\weex\\weex_develop\\abm_dev_weex\\abm-weexSource\\src\\pages\\electronicInvoice\\invoiceImg.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-01b3475e"
...
var _empty = __webpack_require__(5);
...
exports.default = {
    components: { empty: _empty2.default },
    data: function data() {
        return {
            bottom: bottom,
            height: height,
            ...
            id: '',
            invoiceImgUrl: '', //发票的图片url
            isEmpty: false //发票图片是否为空
        };
    },
    ...
    methods: {
        ...
        //下载发票
        clickToDownload: function clickToDownload() {
            var self = this;
            if (self.isEmpty) {
                return;
            }
            utilModule.download([self.invoiceImgUrl], ['发票'], 'image', new Date().getTime(), function (res) {});
        },

        //请求发票的id
        getInvoiceImg: function getInvoiceImg() {
            var self = this;
            self.Get(self.api().electronic_invoice, {
                id: self.id
            }, function (res) {
                if (res.data.code == 0) {
                    if (res.data.data.electronic_invoice != '') {
                        self.invoiceImgUrl = res.data.data.electronic_invoice;
                    } else {
                        self.isEmpty = true;
                    }
                } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    attrs: {
      "resize": "contain",
      "src": "http://img.abmau.com/abmau/0d2c440e2f4f545c5cf8e08ec86b208c.png"
    }
  })])])]), _c('div', {
    staticClass: ["line"]
  }), _c('list', {
  ...
  }, [(!_vm.isEmpty) ? _c('image', {
    staticClass: ["downloadImg"],
    attrs: {
      "src": _vm.invoiceImgUrl
    }
  }) : _vm._e(), (_vm.isEmpty) ? _c('empty') : _vm._e()], 1)])])
},staticRenderFns: []}
module.exports.render._withStripped = true
